...
// checks if the ModelResponseCartMethods type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseCartMethods{}

// ModelResponseCartMethods struct for ModelResponseCartMethods
type ModelResponseCartMethods struct {
	ReturnCode NullableInt32 `json:"return_code,omitempty"`
	ReturnMessage NullableString `json:"return_message,omitempty"`
	Result NullableResponseCartMethodsResult `json:"result,omitempty"`
...
func (o *ModelResponseCartMethods) SetReturnCodeNil() {
...
func (o *ModelResponseCartMethods) SetReturnMessageNil() {
...
func (o *ModelResponseCartMethods) GetResult() ResponseCartMethodsResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseCartMethodsResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseCartMethodsResult and assigns it to the Result field.
func (o *ModelResponseCartMethods) SetResult(v ResponseCartMethodsResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseCartMethods) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseCartMethods) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseCartMethods) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseCartMethods struct {
	value *ModelResponseCartMethods
	isSet bool
}

func (v NullableModelResponseCartMethods) Get() *ModelResponseCartMethods {
	return v.value
}

func (v *NullableModelResponseCartMethods) Set(val *ModelResponseCartMethods) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseCartMethods) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseCartMethods) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseCartMethods(val *ModelResponseCartMethods) *NullableModelResponseCartMethods {
	return &NullableModelResponseCartMethods{value: val, isSet: true}
}

func (v NullableModelResponseCartMethods) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseCartMethods) UnmarshalJSON(src []byte) error {
	v.isSet = true
