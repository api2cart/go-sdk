...
**Result** | Pointer to [**NullableResponseCategoryListResult**](ResponseCategoryListResult.md) |  | [optional] 
...
`func (o *ModelResponseCategoryList) SetReturnCodeNil(b bool)`
...
`func (o *ModelResponseCategoryList) SetReturnMessageNil(b bool)`
...
`func (o *ModelResponseCategoryList) SetPaginationNil(b bool)`
...
`func (o *ModelResponseCategoryList) SetResultNil(b bool)`
...
`func (o *ModelResponseCategoryList) SetAdditionalFieldsNil(b bool)`

 SetAdditionalFieldsNil sets the value for AdditionalFields to be an explicit nil

### UnsetAdditionalFields
`func (o *ModelResponseCategoryList) UnsetAdditionalFields()`
...
`func (o *ModelResponseCategoryList) SetCustomFieldsNil(b bool)`

 SetCustomFieldsNil sets the value for CustomFields to be an explicit nil

### UnsetCustomFields
`func (o *ModelResponseCategoryList) UnsetCustomFields()`
