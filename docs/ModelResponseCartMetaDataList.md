...
**Result** | Pointer to [**NullableResponseCartMetaDataListResult**](ResponseCartMetaDataListResult.md) |  | [optional] 
...
`func (o *ModelResponseCartMetaDataList) SetReturnCodeNil(b bool)`
...
`func (o *ModelResponseCartMetaDataList) SetReturnMessageNil(b bool)`
...
`func (o *ModelResponseCartMetaDataList) SetPaginationNil(b bool)`
...
`func (o *ModelResponseCartMetaDataList) SetResultNil(b bool)`
...
`func (o *ModelResponseCartMetaDataList) SetAdditionalFieldsNil(b bool)`

 SetAdditionalFieldsNil sets the value for AdditionalFields to be an explicit nil

### UnsetAdditionalFields
`func (o *ModelResponseCartMetaDataList) UnsetAdditionalFields()`
...
`func (o *ModelResponseCartMetaDataList) SetCustomFieldsNil(b bool)`

 SetCustomFieldsNil sets the value for CustomFields to be an explicit nil

### UnsetCustomFields
`func (o *ModelResponseCartMetaDataList) UnsetCustomFields()`
