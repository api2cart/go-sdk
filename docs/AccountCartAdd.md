...
**NopcommerceSecret** | Pointer to **string** | nopCommerce webhook signing secret generated by the Api2Cart.Connector plugin. Optional when connecting a store, but required to receive webhooks from it. | [optional] 
...
**ShopifyClientId** | Pointer to **string** | Shopify Client ID | [optional] 
...
### GetNopcommerceSecret

`func (o *AccountCartAdd) GetNopcommerceSecret() string`

GetNopcommerceSecret returns the NopcommerceSecret field if non-nil, zero value otherwise.

### GetNopcommerceSecretOk

`func (o *AccountCartAdd) GetNopcommerceSecretOk() (*string, bool)`

GetNopcommerceSecretOk returns a tuple with the NopcommerceSecret field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetNopcommerceSecret

`func (o *AccountCartAdd) SetNopcommerceSecret(v string)`

SetNopcommerceSecret sets NopcommerceSecret field to given value.

### HasNopcommerceSecret

`func (o *AccountCartAdd) HasNopcommerceSecret() bool`

HasNopcommerceSecret returns a boolean if a field has been set.
...
GetShopifyClientId returns the ShopifyClientId field if non-nil, zero value otherwise.

### GetShopifyClientIdOk

`func (o *AccountCartAdd) GetShopifyClientIdOk() (*string, bool)`

GetShopifyClientIdOk returns a tuple with the ShopifyClientId field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetShopifyClientId sets ShopifyClientId field to given value.
...
GetTemuAppKey returns the TemuAppKey field if non-nil, zero value otherwise.

### GetTemuAppKeyOk

`func (o *AccountCartAdd) GetTemuAppKeyOk() (*string, bool)`

GetTemuAppKeyOk returns a tuple with the TemuAppKey field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetTemuAppKey sets TemuAppKey field to given value.
...
GetTemuAppSecret returns the TemuAppSecret field if non-nil, zero value otherwise.

### GetTemuAppSecretOk

`func (o *AccountCartAdd) GetTemuAppSecretOk() (*string, bool)`

GetTemuAppSecretOk returns a tuple with the TemuAppSecret field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetTemuAppSecret sets TemuAppSecret field to given value.
...
GetTemuAccessToken returns the TemuAccessToken field if non-nil, zero value otherwise.

### GetTemuAccessTokenOk

`func (o *AccountCartAdd) GetTemuAccessTokenOk() (*string, bool)`

GetTemuAccessTokenOk returns a tuple with the TemuAccessToken field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
GetTemuRegion returns the TemuRegion field if non-nil, zero value otherwise.

### GetTemuRegionOk

`func (o *AccountCartAdd) GetTemuRegionOk() (*string, bool)`

GetTemuRegionOk returns a tuple with the TemuRegion field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
