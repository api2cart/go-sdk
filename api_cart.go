...
type ApiCartBridgeRequest struct {
	ctx context.Context
	ApiService *CartAPIService
}

func (r ApiCartBridgeRequest) Execute() (*CartBridge200Response, *http.Response, error) {
	return r.ApiService.CartBridgeExecute(r)
}

/*
CartBridge cart.bridge

Get bridge key and store key

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCartBridgeRequest

Deprecated
*/
func (a *CartAPIService) CartBridge(ctx context.Context) ApiCartBridgeRequest {
	return ApiCartBridgeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Deprecated
func (a *CartAPIService) CartBridgeExecute(r ApiCartBridgeRequest) (*CartBridge200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CartBridge200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CartAPIService.CartBridge")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/cart.bridge.json"
...
type ApiCartClearCacheRequest struct {
	ctx context.Context
	ApiService *CartAPIService
	cacheType *string
}
...
func (r ApiCartClearCacheRequest) CacheType(cacheType string) ApiCartClearCacheRequest {
	r.cacheType = &cacheType
	return r
}

func (r ApiCartClearCacheRequest) Execute() (*CartClearCache200Response, *http.Response, error) {
	return r.ApiService.CartClearCacheExecute(r)
}
...
Clear cache on store.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCartClearCacheRequest

Deprecated
*/
func (a *CartAPIService) CartClearCache(ctx context.Context) ApiCartClearCacheRequest {
	return ApiCartClearCacheRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Deprecated
func (a *CartAPIService) CartClearCacheExecute(r ApiCartClearCacheRequest) (*CartClearCache200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CartClearCache200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CartAPIService.CartClearCache")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/cart.clear_cache.json"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.cacheType == nil {
		return localVarReturnValue, nil, reportError("cacheType is required and must be specified")
	}

	parameterAddToHeaderOrQuery(localVarQueryParams, "cache_type", r.cacheType, "form", "")
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
type ApiCartConfigRequest struct {
	ctx context.Context
	ApiService *CartAPIService
	params *string
	exclude *string
...
// Set this parameter in order to choose which entity fields you want to retrieve
func (r ApiCartConfigRequest) Params(params string) ApiCartConfigRequest {
	r.params = &params
	return r
}

// Set this parameter in order to choose which entity fields you want to ignore. Works only if parameter &#x60;params&#x60; equal force_all
func (r ApiCartConfigRequest) Exclude(exclude string) ApiCartConfigRequest {
	r.exclude = &exclude
	return r
}

func (r ApiCartConfigRequest) Execute() (*CartConfig200Response, *http.Response, error) {
	return r.ApiService.CartConfigExecute(r)
}
...
Get list of cart configs
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCartConfigRequest

Deprecated
*/
func (a *CartAPIService) CartConfig(ctx context.Context) ApiCartConfigRequest {
	return ApiCartConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Deprecated
func (a *CartAPIService) CartConfigExecute(r ApiCartConfigRequest) (*CartConfig200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CartConfig200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CartAPIService.CartConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/cart.config.json"
...
type ApiCartConfigUpdateRequest struct {
	ctx context.Context
	ApiService *CartAPIService
	cartConfigUpdate *CartConfigUpdate
}

func (r ApiCartConfigUpdateRequest) CartConfigUpdate(cartConfigUpdate CartConfigUpdate) ApiCartConfigUpdateRequest {
	r.cartConfigUpdate = &cartConfigUpdate
	return r
}

func (r ApiCartConfigUpdateRequest) Execute() (*CartConfigUpdate200Response, *http.Response, error) {
	return r.ApiService.CartConfigUpdateExecute(r)
}
...
Use this API method to update custom data in client database.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCartConfigUpdateRequest

Deprecated
*/
func (a *CartAPIService) CartConfigUpdate(ctx context.Context) ApiCartConfigUpdateRequest {
	return ApiCartConfigUpdateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Deprecated
func (a *CartAPIService) CartConfigUpdateExecute(r ApiCartConfigUpdateRequest) (*CartConfigUpdate200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CartAPIService.CartConfigUpdate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/cart.config.update.json"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.cartConfigUpdate == nil {
		return localVarReturnValue, nil, reportError("cartConfigUpdate is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.cartConfigUpdate
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["StoreKeyAuth"]; ok {
...
type ApiCartCreateRequest struct {
	ctx context.Context
	ApiService *CartAPIService
	cartCreate *CartCreate
}

func (r ApiCartCreateRequest) CartCreate(cartCreate CartCreate) ApiCartCreateRequest {
	r.cartCreate = &cartCreate
	return r
}

func (r ApiCartCreateRequest) Execute() (*AccountCartAdd200Response, *http.Response, error) {
	return r.ApiService.CartCreateExecute(r)
}
...
Add store to the account
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCartCreateRequest

Deprecated
*/
func (a *CartAPIService) CartCreate(ctx context.Context) ApiCartCreateRequest {
	return ApiCartCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Deprecated
func (a *CartAPIService) CartCreateExecute(r ApiCartCreateRequest) (*AccountCartAdd200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CartAPIService.CartCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/cart.create.json"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.cartCreate == nil {
		return localVarReturnValue, nil, reportError("cartCreate is required and must be specified")
	}
...
type ApiCartDisconnectRequest struct {
	ctx context.Context
	ApiService *CartAPIService
	deleteBridge *bool
}
...
// Identifies if there is a necessity to delete bridge
func (r ApiCartDisconnectRequest) DeleteBridge(deleteBridge bool) ApiCartDisconnectRequest {
	r.deleteBridge = &deleteBridge
	return r
}

func (r ApiCartDisconnectRequest) Execute() (*CartDisconnect200Response, *http.Response, error) {
	return r.ApiService.CartDisconnectExecute(r)
}
...
Disconnect with the store and clear store session data.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCartDisconnectRequest

Deprecated
*/
func (a *CartAPIService) CartDisconnect(ctx context.Context) ApiCartDisconnectRequest {
	return ApiCartDisconnectRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Deprecated
func (a *CartAPIService) CartDisconnectExecute(r ApiCartDisconnectRequest) (*CartDisconnect200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CartDisconnect200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CartAPIService.CartDisconnect")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/cart.disconnect.json"
...
type ApiCartListRequest struct {
	ctx context.Context
	ApiService *CartAPIService
}

func (r ApiCartListRequest) Execute() (*CartList200Response, *http.Response, error) {
	return r.ApiService.CartListExecute(r)
}
...
Get list of supported carts
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCartListRequest

Deprecated
*/
func (a *CartAPIService) CartList(ctx context.Context) ApiCartListRequest {
	return ApiCartListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Deprecated
func (a *CartAPIService) CartListExecute(r ApiCartListRequest) (*CartList200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CartList200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CartAPIService.CartList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/cart.list.json"
