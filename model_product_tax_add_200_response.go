...
// checks if the ProductTaxAdd200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductTaxAdd200Response{}

// ProductTaxAdd200Response struct for ProductTaxAdd200Response
type ProductTaxAdd200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *ProductTaxAdd200ResponseResult `json:"result,omitempty"`
}
...
func (o *ProductTaxAdd200Response) GetResult() ProductTaxAdd200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret ProductTaxAdd200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given ProductTaxAdd200ResponseResult and assigns it to the Result field.
func (o *ProductTaxAdd200Response) SetResult(v ProductTaxAdd200ResponseResult) {
	o.Result = &v
}

func (o ProductTaxAdd200Response) MarshalJSON() ([]byte, error) {
...
func (o ProductTaxAdd200Response) ToMap() (map[string]interface{}, error) {
...
type NullableProductTaxAdd200Response struct {
	value *ProductTaxAdd200Response
	isSet bool
}

func (v NullableProductTaxAdd200Response) Get() *ProductTaxAdd200Response {
	return v.value
}

func (v *NullableProductTaxAdd200Response) Set(val *ProductTaxAdd200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableProductTaxAdd200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableProductTaxAdd200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductTaxAdd200Response(val *ProductTaxAdd200Response) *NullableProductTaxAdd200Response {
	return &NullableProductTaxAdd200Response{value: val, isSet: true}
}

func (v NullableProductTaxAdd200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductTaxAdd200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
