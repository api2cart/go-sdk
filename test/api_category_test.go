...
func Test_openapi_CategoryAPIService(t *testing.T) {
	...
	t.Run("Test CategoryAPIService CategoryDeleteBatch", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.CategoryAPI.CategoryDeleteBatch(context.Background()).Execute()
