...
// checks if the OrderShipmentAdd200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderShipmentAdd200Response{}

// OrderShipmentAdd200Response struct for OrderShipmentAdd200Response
type OrderShipmentAdd200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *OrderShipmentAdd200ResponseResult `json:"result,omitempty"`
}
...
func NewOrderShipmentAdd200Response() *OrderShipmentAdd200Response {
	this := OrderShipmentAdd200Response{}
	return &this
}
...
func (o *OrderShipmentAdd200Response) GetResult() OrderShipmentAdd200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret OrderShipmentAdd200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given OrderShipmentAdd200ResponseResult and assigns it to the Result field.
func (o *OrderShipmentAdd200Response) SetResult(v OrderShipmentAdd200ResponseResult) {
	o.Result = &v
}

func (o OrderShipmentAdd200Response) MarshalJSON() ([]byte, error) {
...
func (o OrderShipmentAdd200Response) ToMap() (map[string]interface{}, error) {
...
type NullableOrderShipmentAdd200Response struct {
	value *OrderShipmentAdd200Response
	isSet bool
}

func (v NullableOrderShipmentAdd200Response) Get() *OrderShipmentAdd200Response {
	return v.value
}

func (v *NullableOrderShipmentAdd200Response) Set(val *OrderShipmentAdd200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderShipmentAdd200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderShipmentAdd200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderShipmentAdd200Response(val *OrderShipmentAdd200Response) *NullableOrderShipmentAdd200Response {
	return &NullableOrderShipmentAdd200Response{value: val, isSet: true}
}

func (v NullableOrderShipmentAdd200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderShipmentAdd200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
