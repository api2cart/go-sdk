...
// checks if the CartCatalogPriceRulesCount200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CartCatalogPriceRulesCount200Response{}

// CartCatalogPriceRulesCount200Response struct for CartCatalogPriceRulesCount200Response
type CartCatalogPriceRulesCount200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *CartCatalogPriceRulesCount200ResponseResult `json:"result,omitempty"`
}
...
func NewCartCatalogPriceRulesCount200Response() *CartCatalogPriceRulesCount200Response {
	this := CartCatalogPriceRulesCount200Response{}
	return &this
}
...
func (o *CartCatalogPriceRulesCount200Response) GetResult() CartCatalogPriceRulesCount200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret CartCatalogPriceRulesCount200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given CartCatalogPriceRulesCount200ResponseResult and assigns it to the Result field.
func (o *CartCatalogPriceRulesCount200Response) SetResult(v CartCatalogPriceRulesCount200ResponseResult) {
	o.Result = &v
}

func (o CartCatalogPriceRulesCount200Response) MarshalJSON() ([]byte, error) {
...
func (o CartCatalogPriceRulesCount200Response) ToMap() (map[string]interface{}, error) {
...
type NullableCartCatalogPriceRulesCount200Response struct {
	value *CartCatalogPriceRulesCount200Response
	isSet bool
}

func (v NullableCartCatalogPriceRulesCount200Response) Get() *CartCatalogPriceRulesCount200Response {
	return v.value
}

func (v *NullableCartCatalogPriceRulesCount200Response) Set(val *CartCatalogPriceRulesCount200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCartCatalogPriceRulesCount200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCartCatalogPriceRulesCount200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCartCatalogPriceRulesCount200Response(val *CartCatalogPriceRulesCount200Response) *NullableCartCatalogPriceRulesCount200Response {
	return &NullableCartCatalogPriceRulesCount200Response{value: val, isSet: true}
}

func (v NullableCartCatalogPriceRulesCount200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCartCatalogPriceRulesCount200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
