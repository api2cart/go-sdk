...
// checks if the ProductVariantList200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductVariantList200Response{}

// ProductVariantList200Response struct for ProductVariantList200Response
type ProductVariantList200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *ProductVariantList200ResponseResult `json:"result,omitempty"`
}
...
func NewProductVariantList200Response() *ProductVariantList200Response {
	this := ProductVariantList200Response{}
	return &this
}
...
func (o *ProductVariantList200Response) GetResult() ProductVariantList200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret ProductVariantList200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given ProductVariantList200ResponseResult and assigns it to the Result field.
func (o *ProductVariantList200Response) SetResult(v ProductVariantList200ResponseResult) {
	o.Result = &v
}

func (o ProductVariantList200Response) MarshalJSON() ([]byte, error) {
...
func (o ProductVariantList200Response) ToMap() (map[string]interface{}, error) {
...
type NullableProductVariantList200Response struct {
	value *ProductVariantList200Response
	isSet bool
}

func (v NullableProductVariantList200Response) Get() *ProductVariantList200Response {
	return v.value
}

func (v *NullableProductVariantList200Response) Set(val *ProductVariantList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableProductVariantList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableProductVariantList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductVariantList200Response(val *ProductVariantList200Response) *NullableProductVariantList200Response {
	return &NullableProductVariantList200Response{value: val, isSet: true}
}

func (v NullableProductVariantList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductVariantList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
