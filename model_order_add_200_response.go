...
// checks if the OrderAdd200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderAdd200Response{}

// OrderAdd200Response struct for OrderAdd200Response
type OrderAdd200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *OrderAdd200ResponseResult `json:"result,omitempty"`
}
...
func (o *OrderAdd200Response) GetResult() OrderAdd200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret OrderAdd200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given OrderAdd200ResponseResult and assigns it to the Result field.
func (o *OrderAdd200Response) SetResult(v OrderAdd200ResponseResult) {
	o.Result = &v
}

func (o OrderAdd200Response) MarshalJSON() ([]byte, error) {
...
func (o OrderAdd200Response) ToMap() (map[string]interface{}, error) {
...
type NullableOrderAdd200Response struct {
	value *OrderAdd200Response
	isSet bool
}

func (v NullableOrderAdd200Response) Get() *OrderAdd200Response {
	return v.value
}

func (v *NullableOrderAdd200Response) Set(val *OrderAdd200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderAdd200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderAdd200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderAdd200Response(val *OrderAdd200Response) *NullableOrderAdd200Response {
	return &NullableOrderAdd200Response{value: val, isSet: true}
}

func (v NullableOrderAdd200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderAdd200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
