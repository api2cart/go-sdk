...
type ModelResponseProductChildItemList struct {
	...
	Result NullableResponseProductChildItemListResult `json:"result,omitempty"`
...
func (o *ModelResponseProductChildItemList) SetReturnCodeNil() {
...
func (o *ModelResponseProductChildItemList) SetReturnMessageNil() {
...
func (o *ModelResponseProductChildItemList) SetPaginationNil() {
...
// SetResult gets a reference to the given NullableResponseProductChildItemListResult and assigns it to the Result field.
func (o *ModelResponseProductChildItemList) SetResult(v ResponseProductChildItemListResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseProductChildItemList) SetResultNil() {
	o.Result.Set(nil)
}
