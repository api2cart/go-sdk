...
// checks if the ReturnStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReturnStatus{}

// ReturnStatus struct for ReturnStatus
...
func (o ReturnStatus) MarshalJSON() ([]byte, error) {
...
func (o ReturnStatus) ToMap() (map[string]interface{}, error) {
