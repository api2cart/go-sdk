...
// checks if the ModelResponseReturnCount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseReturnCount{}

// ModelResponseReturnCount struct for ModelResponseReturnCount
type ModelResponseReturnCount struct {
	ReturnCode NullableInt32 `json:"return_code,omitempty"`
	ReturnMessage NullableString `json:"return_message,omitempty"`
	Result NullableResponseReturnCountResult `json:"result,omitempty"`
...
func (o *ModelResponseReturnCount) SetReturnCodeNil() {
...
func (o *ModelResponseReturnCount) SetReturnMessageNil() {
...
func (o *ModelResponseReturnCount) GetResult() ResponseReturnCountResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseReturnCountResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseReturnCountResult and assigns it to the Result field.
func (o *ModelResponseReturnCount) SetResult(v ResponseReturnCountResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseReturnCount) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseReturnCount) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseReturnCount) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseReturnCount struct {
	value *ModelResponseReturnCount
	isSet bool
}

func (v NullableModelResponseReturnCount) Get() *ModelResponseReturnCount {
	return v.value
}

func (v *NullableModelResponseReturnCount) Set(val *ModelResponseReturnCount) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseReturnCount) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseReturnCount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseReturnCount(val *ModelResponseReturnCount) *NullableModelResponseReturnCount {
	return &NullableModelResponseReturnCount{value: val, isSet: true}
}

func (v NullableModelResponseReturnCount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseReturnCount) UnmarshalJSON(src []byte) error {
	v.isSet = true
