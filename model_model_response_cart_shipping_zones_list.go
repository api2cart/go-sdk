...
type ModelResponseCartShippingZonesList struct {
	...
	Result *ResponseCartShippingZonesListResult `json:"result,omitempty"`
...
// SetResult gets a reference to the given ResponseCartShippingZonesListResult and assigns it to the Result field.
