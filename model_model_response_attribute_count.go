...
// checks if the ModelResponseAttributeCount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseAttributeCount{}

// ModelResponseAttributeCount struct for ModelResponseAttributeCount
type ModelResponseAttributeCount struct {
	ReturnCode NullableInt32 `json:"return_code,omitempty"`
	ReturnMessage NullableString `json:"return_message,omitempty"`
	Result NullableResponseAttributeCountResult `json:"result,omitempty"`
...
func NewModelResponseAttributeCount() *ModelResponseAttributeCount {
	this := ModelResponseAttributeCount{}
	return &this
}
...
func (o *ModelResponseAttributeCount) SetReturnCodeNil() {
...
func (o *ModelResponseAttributeCount) SetReturnMessageNil() {
...
func (o *ModelResponseAttributeCount) GetResult() ResponseAttributeCountResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseAttributeCountResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseAttributeCountResult and assigns it to the Result field.
func (o *ModelResponseAttributeCount) SetResult(v ResponseAttributeCountResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseAttributeCount) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseAttributeCount) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseAttributeCount) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseAttributeCount struct {
	value *ModelResponseAttributeCount
	isSet bool
}

func (v NullableModelResponseAttributeCount) Get() *ModelResponseAttributeCount {
	return v.value
}

func (v *NullableModelResponseAttributeCount) Set(val *ModelResponseAttributeCount) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseAttributeCount) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseAttributeCount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseAttributeCount(val *ModelResponseAttributeCount) *NullableModelResponseAttributeCount {
	return &NullableModelResponseAttributeCount{value: val, isSet: true}
}

func (v NullableModelResponseAttributeCount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseAttributeCount) UnmarshalJSON(src []byte) error {
	v.isSet = true
