...
type ModelResponseProductCurrencyList struct {
	...
	Result *ResponseProductCurrencyListResult `json:"result,omitempty"`
...
// SetResult gets a reference to the given ResponseProductCurrencyListResult and assigns it to the Result field.
