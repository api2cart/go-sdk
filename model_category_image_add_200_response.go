...
// checks if the CategoryImageAdd200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryImageAdd200Response{}

// CategoryImageAdd200Response struct for CategoryImageAdd200Response
type CategoryImageAdd200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *CategoryImageAdd200ResponseResult `json:"result,omitempty"`
}
...
func NewCategoryImageAdd200Response() *CategoryImageAdd200Response {
	this := CategoryImageAdd200Response{}
	return &this
}
...
func (o *CategoryImageAdd200Response) GetResult() CategoryImageAdd200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret CategoryImageAdd200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given CategoryImageAdd200ResponseResult and assigns it to the Result field.
func (o *CategoryImageAdd200Response) SetResult(v CategoryImageAdd200ResponseResult) {
	o.Result = &v
}

func (o CategoryImageAdd200Response) MarshalJSON() ([]byte, error) {
...
func (o CategoryImageAdd200Response) ToMap() (map[string]interface{}, error) {
...
type NullableCategoryImageAdd200Response struct {
	value *CategoryImageAdd200Response
	isSet bool
}

func (v NullableCategoryImageAdd200Response) Get() *CategoryImageAdd200Response {
	return v.value
}

func (v *NullableCategoryImageAdd200Response) Set(val *CategoryImageAdd200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryImageAdd200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryImageAdd200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryImageAdd200Response(val *CategoryImageAdd200Response) *NullableCategoryImageAdd200Response {
	return &NullableCategoryImageAdd200Response{value: val, isSet: true}
}

func (v NullableCategoryImageAdd200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryImageAdd200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
