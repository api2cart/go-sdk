...
// checks if the ProductManufacturerAdd200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductManufacturerAdd200Response{}

// ProductManufacturerAdd200Response struct for ProductManufacturerAdd200Response
type ProductManufacturerAdd200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *ProductManufacturerAdd200ResponseResult `json:"result,omitempty"`
}
...
func NewProductManufacturerAdd200Response() *ProductManufacturerAdd200Response {
	this := ProductManufacturerAdd200Response{}
	return &this
}
...
func (o *ProductManufacturerAdd200Response) GetResult() ProductManufacturerAdd200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret ProductManufacturerAdd200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given ProductManufacturerAdd200ResponseResult and assigns it to the Result field.
func (o *ProductManufacturerAdd200Response) SetResult(v ProductManufacturerAdd200ResponseResult) {
	o.Result = &v
}

func (o ProductManufacturerAdd200Response) MarshalJSON() ([]byte, error) {
...
func (o ProductManufacturerAdd200Response) ToMap() (map[string]interface{}, error) {
...
type NullableProductManufacturerAdd200Response struct {
	value *ProductManufacturerAdd200Response
	isSet bool
}

func (v NullableProductManufacturerAdd200Response) Get() *ProductManufacturerAdd200Response {
	return v.value
}

func (v *NullableProductManufacturerAdd200Response) Set(val *ProductManufacturerAdd200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableProductManufacturerAdd200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableProductManufacturerAdd200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductManufacturerAdd200Response(val *ProductManufacturerAdd200Response) *NullableProductManufacturerAdd200Response {
	return &NullableProductManufacturerAdd200Response{value: val, isSet: true}
}

func (v NullableProductManufacturerAdd200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductManufacturerAdd200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
