...
// checks if the ModelResponseProductAttributeList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseProductAttributeList{}

// ModelResponseProductAttributeList struct for ModelResponseProductAttributeList
type ModelResponseProductAttributeList struct {
	...
	Result NullableResponseProductAttributeListResult `json:"result,omitempty"`
...
func NewModelResponseProductAttributeList() *ModelResponseProductAttributeList {
	this := ModelResponseProductAttributeList{}
	return &this
}
...
func (o *ModelResponseProductAttributeList) SetReturnCodeNil() {
...
func (o *ModelResponseProductAttributeList) SetReturnMessageNil() {
...
func (o *ModelResponseProductAttributeList) SetPaginationNil() {
...
func (o *ModelResponseProductAttributeList) GetResult() ResponseProductAttributeListResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseProductAttributeListResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseProductAttributeListResult and assigns it to the Result field.
func (o *ModelResponseProductAttributeList) SetResult(v ResponseProductAttributeListResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseProductAttributeList) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseProductAttributeList) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseProductAttributeList) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseProductAttributeList struct {
	value *ModelResponseProductAttributeList
	isSet bool
}

func (v NullableModelResponseProductAttributeList) Get() *ModelResponseProductAttributeList {
	return v.value
}

func (v *NullableModelResponseProductAttributeList) Set(val *ModelResponseProductAttributeList) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseProductAttributeList) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseProductAttributeList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseProductAttributeList(val *ModelResponseProductAttributeList) *NullableModelResponseProductAttributeList {
	return &NullableModelResponseProductAttributeList{value: val, isSet: true}
}

func (v NullableModelResponseProductAttributeList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseProductAttributeList) UnmarshalJSON(src []byte) error {
	v.isSet = true
