...
// checks if the ModelResponseOrderList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseOrderList{}

// ModelResponseOrderList struct for ModelResponseOrderList
type ModelResponseOrderList struct {
	...
	Result NullableResponseOrderListResult `json:"result,omitempty"`
...
func (o *ModelResponseOrderList) SetReturnCodeNil() {
...
func (o *ModelResponseOrderList) SetReturnMessageNil() {
...
func (o *ModelResponseOrderList) SetPaginationNil() {
...
func (o *ModelResponseOrderList) GetResult() ResponseOrderListResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseOrderListResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseOrderListResult and assigns it to the Result field.
func (o *ModelResponseOrderList) SetResult(v ResponseOrderListResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseOrderList) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseOrderList) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseOrderList) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseOrderList struct {
	value *ModelResponseOrderList
	isSet bool
}

func (v NullableModelResponseOrderList) Get() *ModelResponseOrderList {
	return v.value
}

func (v *NullableModelResponseOrderList) Set(val *ModelResponseOrderList) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseOrderList) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseOrderList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseOrderList(val *ModelResponseOrderList) *NullableModelResponseOrderList {
	return &NullableModelResponseOrderList{value: val, isSet: true}
}

func (v NullableModelResponseOrderList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseOrderList) UnmarshalJSON(src []byte) error {
	v.isSet = true
