...
// checks if the ModelResponseCustomerFind type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseCustomerFind{}

// ModelResponseCustomerFind struct for ModelResponseCustomerFind
type ModelResponseCustomerFind struct {
	ReturnCode NullableInt32 `json:"return_code,omitempty"`
	ReturnMessage NullableString `json:"return_message,omitempty"`
	Result NullableResponseCustomerFindResult `json:"result,omitempty"`
...
func NewModelResponseCustomerFind() *ModelResponseCustomerFind {
	this := ModelResponseCustomerFind{}
	return &this
}
...
func (o *ModelResponseCustomerFind) SetReturnCodeNil() {
...
func (o *ModelResponseCustomerFind) SetReturnMessageNil() {
...
func (o *ModelResponseCustomerFind) GetResult() ResponseCustomerFindResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseCustomerFindResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseCustomerFindResult and assigns it to the Result field.
func (o *ModelResponseCustomerFind) SetResult(v ResponseCustomerFindResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseCustomerFind) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseCustomerFind) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseCustomerFind) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseCustomerFind struct {
	value *ModelResponseCustomerFind
	isSet bool
}

func (v NullableModelResponseCustomerFind) Get() *ModelResponseCustomerFind {
	return v.value
}

func (v *NullableModelResponseCustomerFind) Set(val *ModelResponseCustomerFind) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseCustomerFind) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseCustomerFind) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseCustomerFind(val *ModelResponseCustomerFind) *NullableModelResponseCustomerFind {
	return &NullableModelResponseCustomerFind{value: val, isSet: true}
}

func (v NullableModelResponseCustomerFind) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseCustomerFind) UnmarshalJSON(src []byte) error {
	v.isSet = true
