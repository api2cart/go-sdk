...
// checks if the ModelResponseOrderShipmentList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseOrderShipmentList{}

// ModelResponseOrderShipmentList struct for ModelResponseOrderShipmentList
type ModelResponseOrderShipmentList struct {
	...
	Result NullableResponseOrderShipmentListResult `json:"result,omitempty"`
...
func NewModelResponseOrderShipmentList() *ModelResponseOrderShipmentList {
	this := ModelResponseOrderShipmentList{}
	return &this
}
...
func (o *ModelResponseOrderShipmentList) SetReturnCodeNil() {
...
func (o *ModelResponseOrderShipmentList) SetReturnMessageNil() {
...
func (o *ModelResponseOrderShipmentList) SetPaginationNil() {
...
func (o *ModelResponseOrderShipmentList) GetResult() ResponseOrderShipmentListResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseOrderShipmentListResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseOrderShipmentListResult and assigns it to the Result field.
func (o *ModelResponseOrderShipmentList) SetResult(v ResponseOrderShipmentListResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseOrderShipmentList) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseOrderShipmentList) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseOrderShipmentList) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseOrderShipmentList struct {
	value *ModelResponseOrderShipmentList
	isSet bool
}

func (v NullableModelResponseOrderShipmentList) Get() *ModelResponseOrderShipmentList {
	return v.value
}

func (v *NullableModelResponseOrderShipmentList) Set(val *ModelResponseOrderShipmentList) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseOrderShipmentList) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseOrderShipmentList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseOrderShipmentList(val *ModelResponseOrderShipmentList) *NullableModelResponseOrderShipmentList {
	return &NullableModelResponseOrderShipmentList{value: val, isSet: true}
}

func (v NullableModelResponseOrderShipmentList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseOrderShipmentList) UnmarshalJSON(src []byte) error {
	v.isSet = true
