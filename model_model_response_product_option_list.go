...
// checks if the ModelResponseProductOptionList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseProductOptionList{}

// ModelResponseProductOptionList struct for ModelResponseProductOptionList
type ModelResponseProductOptionList struct {
	...
	Result NullableResponseProductOptionListResult `json:"result,omitempty"`
...
func NewModelResponseProductOptionList() *ModelResponseProductOptionList {
	this := ModelResponseProductOptionList{}
	return &this
}
...
func (o *ModelResponseProductOptionList) SetReturnCodeNil() {
...
func (o *ModelResponseProductOptionList) SetReturnMessageNil() {
...
func (o *ModelResponseProductOptionList) SetPaginationNil() {
...
func (o *ModelResponseProductOptionList) GetResult() ResponseProductOptionListResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseProductOptionListResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseProductOptionListResult and assigns it to the Result field.
func (o *ModelResponseProductOptionList) SetResult(v ResponseProductOptionListResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseProductOptionList) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseProductOptionList) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseProductOptionList) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseProductOptionList struct {
	value *ModelResponseProductOptionList
	isSet bool
}

func (v NullableModelResponseProductOptionList) Get() *ModelResponseProductOptionList {
	return v.value
}

func (v *NullableModelResponseProductOptionList) Set(val *ModelResponseProductOptionList) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseProductOptionList) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseProductOptionList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseProductOptionList(val *ModelResponseProductOptionList) *NullableModelResponseProductOptionList {
	return &NullableModelResponseProductOptionList{value: val, isSet: true}
}

func (v NullableModelResponseProductOptionList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseProductOptionList) UnmarshalJSON(src []byte) error {
	v.isSet = true
