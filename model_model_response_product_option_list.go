...
type ModelResponseProductOptionList struct {
	...
	Result *ResponseProductOptionListResult `json:"result,omitempty"`
...
// SetResult gets a reference to the given ResponseProductOptionListResult and assigns it to the Result field.
