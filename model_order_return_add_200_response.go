...
// checks if the OrderReturnAdd200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderReturnAdd200Response{}

// OrderReturnAdd200Response struct for OrderReturnAdd200Response
type OrderReturnAdd200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *OrderReturnAdd200ResponseResult `json:"result,omitempty"`
}
...
func NewOrderReturnAdd200Response() *OrderReturnAdd200Response {
	this := OrderReturnAdd200Response{}
	return &this
}
...
func (o *OrderReturnAdd200Response) GetResult() OrderReturnAdd200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret OrderReturnAdd200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given OrderReturnAdd200ResponseResult and assigns it to the Result field.
func (o *OrderReturnAdd200Response) SetResult(v OrderReturnAdd200ResponseResult) {
	o.Result = &v
}

func (o OrderReturnAdd200Response) MarshalJSON() ([]byte, error) {
...
func (o OrderReturnAdd200Response) ToMap() (map[string]interface{}, error) {
...
type NullableOrderReturnAdd200Response struct {
	value *OrderReturnAdd200Response
	isSet bool
}

func (v NullableOrderReturnAdd200Response) Get() *OrderReturnAdd200Response {
	return v.value
}

func (v *NullableOrderReturnAdd200Response) Set(val *OrderReturnAdd200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderReturnAdd200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderReturnAdd200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderReturnAdd200Response(val *OrderReturnAdd200Response) *NullableOrderReturnAdd200Response {
	return &NullableOrderReturnAdd200Response{value: val, isSet: true}
}

func (v NullableOrderReturnAdd200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderReturnAdd200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
