...
// checks if the CustomerGroupAdd200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerGroupAdd200Response{}

// CustomerGroupAdd200Response struct for CustomerGroupAdd200Response
type CustomerGroupAdd200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *CustomerGroupAdd200ResponseResult `json:"result,omitempty"`
}
...
func NewCustomerGroupAdd200Response() *CustomerGroupAdd200Response {
	this := CustomerGroupAdd200Response{}
	return &this
}
...
func (o *CustomerGroupAdd200Response) GetResult() CustomerGroupAdd200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret CustomerGroupAdd200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given CustomerGroupAdd200ResponseResult and assigns it to the Result field.
func (o *CustomerGroupAdd200Response) SetResult(v CustomerGroupAdd200ResponseResult) {
	o.Result = &v
}

func (o CustomerGroupAdd200Response) MarshalJSON() ([]byte, error) {
...
func (o CustomerGroupAdd200Response) ToMap() (map[string]interface{}, error) {
...
type NullableCustomerGroupAdd200Response struct {
	value *CustomerGroupAdd200Response
	isSet bool
}

func (v NullableCustomerGroupAdd200Response) Get() *CustomerGroupAdd200Response {
	return v.value
}

func (v *NullableCustomerGroupAdd200Response) Set(val *CustomerGroupAdd200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerGroupAdd200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerGroupAdd200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerGroupAdd200Response(val *CustomerGroupAdd200Response) *NullableCustomerGroupAdd200Response {
	return &NullableCustomerGroupAdd200Response{value: val, isSet: true}
}

func (v NullableCustomerGroupAdd200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerGroupAdd200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
