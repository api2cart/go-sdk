...
// checks if the ModelResponseCustomerAttributeList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseCustomerAttributeList{}

// ModelResponseCustomerAttributeList struct for ModelResponseCustomerAttributeList
type ModelResponseCustomerAttributeList struct {
	...
	Result NullableResponseCustomerAttributeListResult `json:"result,omitempty"`
...
func NewModelResponseCustomerAttributeList() *ModelResponseCustomerAttributeList {
	this := ModelResponseCustomerAttributeList{}
	return &this
}
...
func (o *ModelResponseCustomerAttributeList) SetReturnCodeNil() {
...
func (o *ModelResponseCustomerAttributeList) SetReturnMessageNil() {
...
func (o *ModelResponseCustomerAttributeList) SetPaginationNil() {
...
func (o *ModelResponseCustomerAttributeList) GetResult() ResponseCustomerAttributeListResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseCustomerAttributeListResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseCustomerAttributeListResult and assigns it to the Result field.
func (o *ModelResponseCustomerAttributeList) SetResult(v ResponseCustomerAttributeListResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseCustomerAttributeList) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseCustomerAttributeList) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseCustomerAttributeList) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseCustomerAttributeList struct {
	value *ModelResponseCustomerAttributeList
	isSet bool
}

func (v NullableModelResponseCustomerAttributeList) Get() *ModelResponseCustomerAttributeList {
	return v.value
}

func (v *NullableModelResponseCustomerAttributeList) Set(val *ModelResponseCustomerAttributeList) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseCustomerAttributeList) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseCustomerAttributeList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseCustomerAttributeList(val *ModelResponseCustomerAttributeList) *NullableModelResponseCustomerAttributeList {
	return &NullableModelResponseCustomerAttributeList{value: val, isSet: true}
}

func (v NullableModelResponseCustomerAttributeList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseCustomerAttributeList) UnmarshalJSON(src []byte) error {
	v.isSet = true
