...
// checks if the ModelResponseReturnReasonList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseReturnReasonList{}

// ModelResponseReturnReasonList struct for ModelResponseReturnReasonList
type ModelResponseReturnReasonList struct {
	ReturnCode NullableInt32 `json:"return_code,omitempty"`
	ReturnMessage NullableString `json:"return_message,omitempty"`
	Result NullableResponseReturnReasonListResult `json:"result,omitempty"`
...
func NewModelResponseReturnReasonList() *ModelResponseReturnReasonList {
	this := ModelResponseReturnReasonList{}
	return &this
}
...
func (o *ModelResponseReturnReasonList) SetReturnCodeNil() {
...
func (o *ModelResponseReturnReasonList) SetReturnMessageNil() {
...
func (o *ModelResponseReturnReasonList) GetResult() ResponseReturnReasonListResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseReturnReasonListResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseReturnReasonListResult and assigns it to the Result field.
func (o *ModelResponseReturnReasonList) SetResult(v ResponseReturnReasonListResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseReturnReasonList) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseReturnReasonList) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseReturnReasonList) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseReturnReasonList struct {
	value *ModelResponseReturnReasonList
	isSet bool
}

func (v NullableModelResponseReturnReasonList) Get() *ModelResponseReturnReasonList {
	return v.value
}

func (v *NullableModelResponseReturnReasonList) Set(val *ModelResponseReturnReasonList) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseReturnReasonList) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseReturnReasonList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseReturnReasonList(val *ModelResponseReturnReasonList) *NullableModelResponseReturnReasonList {
	return &NullableModelResponseReturnReasonList{value: val, isSet: true}
}

func (v NullableModelResponseReturnReasonList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseReturnReasonList) UnmarshalJSON(src []byte) error {
	v.isSet = true
