...
// checks if the BasketLiveShippingServiceList200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BasketLiveShippingServiceList200Response{}

// BasketLiveShippingServiceList200Response struct for BasketLiveShippingServiceList200Response
type BasketLiveShippingServiceList200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *BasketLiveShippingServiceList200ResponseResult `json:"result,omitempty"`
}
...
func NewBasketLiveShippingServiceList200Response() *BasketLiveShippingServiceList200Response {
	this := BasketLiveShippingServiceList200Response{}
	return &this
}
...
func (o *BasketLiveShippingServiceList200Response) GetResult() BasketLiveShippingServiceList200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret BasketLiveShippingServiceList200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given BasketLiveShippingServiceList200ResponseResult and assigns it to the Result field.
func (o *BasketLiveShippingServiceList200Response) SetResult(v BasketLiveShippingServiceList200ResponseResult) {
	o.Result = &v
}

func (o BasketLiveShippingServiceList200Response) MarshalJSON() ([]byte, error) {
...
func (o BasketLiveShippingServiceList200Response) ToMap() (map[string]interface{}, error) {
...
type NullableBasketLiveShippingServiceList200Response struct {
	value *BasketLiveShippingServiceList200Response
	isSet bool
}

func (v NullableBasketLiveShippingServiceList200Response) Get() *BasketLiveShippingServiceList200Response {
	return v.value
}

func (v *NullableBasketLiveShippingServiceList200Response) Set(val *BasketLiveShippingServiceList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBasketLiveShippingServiceList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBasketLiveShippingServiceList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBasketLiveShippingServiceList200Response(val *BasketLiveShippingServiceList200Response) *NullableBasketLiveShippingServiceList200Response {
	return &NullableBasketLiveShippingServiceList200Response{value: val, isSet: true}
}

func (v NullableBasketLiveShippingServiceList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBasketLiveShippingServiceList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
