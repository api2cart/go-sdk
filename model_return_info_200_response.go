...
// checks if the ReturnInfo200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReturnInfo200Response{}

// ReturnInfo200Response struct for ReturnInfo200Response
type ReturnInfo200Response struct {
...
// SetResult gets a reference to the given Return and assigns it to the Result field.
func (o *ReturnInfo200Response) SetResult(v Return) {
	o.Result = &v
}

func (o ReturnInfo200Response) MarshalJSON() ([]byte, error) {
...
func (o ReturnInfo200Response) ToMap() (map[string]interface{}, error) {
...
type NullableReturnInfo200Response struct {
	value *ReturnInfo200Response
	isSet bool
}

func (v NullableReturnInfo200Response) Get() *ReturnInfo200Response {
	return v.value
}

func (v *NullableReturnInfo200Response) Set(val *ReturnInfo200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableReturnInfo200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableReturnInfo200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReturnInfo200Response(val *ReturnInfo200Response) *NullableReturnInfo200Response {
	return &NullableReturnInfo200Response{value: val, isSet: true}
}

func (v NullableReturnInfo200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReturnInfo200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
