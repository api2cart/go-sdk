...
// checks if the ModelResponseCategoryAssign type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseCategoryAssign{}

// ModelResponseCategoryAssign struct for ModelResponseCategoryAssign
type ModelResponseCategoryAssign struct {
	ReturnCode NullableInt32 `json:"return_code,omitempty"`
	ReturnMessage NullableString `json:"return_message,omitempty"`
	Result NullableResponseCategoryAssignResult `json:"result,omitempty"`
...
func NewModelResponseCategoryAssign() *ModelResponseCategoryAssign {
	this := ModelResponseCategoryAssign{}
	return &this
}
...
func (o *ModelResponseCategoryAssign) SetReturnCodeNil() {
...
func (o *ModelResponseCategoryAssign) SetReturnMessageNil() {
...
func (o *ModelResponseCategoryAssign) GetResult() ResponseCategoryAssignResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseCategoryAssignResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseCategoryAssignResult and assigns it to the Result field.
func (o *ModelResponseCategoryAssign) SetResult(v ResponseCategoryAssignResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseCategoryAssign) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseCategoryAssign) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseCategoryAssign) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseCategoryAssign struct {
	value *ModelResponseCategoryAssign
	isSet bool
}

func (v NullableModelResponseCategoryAssign) Get() *ModelResponseCategoryAssign {
	return v.value
}

func (v *NullableModelResponseCategoryAssign) Set(val *ModelResponseCategoryAssign) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseCategoryAssign) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseCategoryAssign) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseCategoryAssign(val *ModelResponseCategoryAssign) *NullableModelResponseCategoryAssign {
	return &NullableModelResponseCategoryAssign{value: val, isSet: true}
}

func (v NullableModelResponseCategoryAssign) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseCategoryAssign) UnmarshalJSON(src []byte) error {
	v.isSet = true
