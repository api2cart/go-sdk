...
// checks if the CategoryCount200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryCount200Response{}

// CategoryCount200Response struct for CategoryCount200Response
type CategoryCount200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *CategoryCount200ResponseResult `json:"result,omitempty"`
}
...
func (o *CategoryCount200Response) GetResult() CategoryCount200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret CategoryCount200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given CategoryCount200ResponseResult and assigns it to the Result field.
func (o *CategoryCount200Response) SetResult(v CategoryCount200ResponseResult) {
	o.Result = &v
}

func (o CategoryCount200Response) MarshalJSON() ([]byte, error) {
...
func (o CategoryCount200Response) ToMap() (map[string]interface{}, error) {
...
type NullableCategoryCount200Response struct {
	value *CategoryCount200Response
	isSet bool
}

func (v NullableCategoryCount200Response) Get() *CategoryCount200Response {
	return v.value
}

func (v *NullableCategoryCount200Response) Set(val *CategoryCount200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryCount200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryCount200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryCount200Response(val *CategoryCount200Response) *NullableCategoryCount200Response {
	return &NullableCategoryCount200Response{value: val, isSet: true}
}

func (v NullableCategoryCount200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryCount200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
