...
// Retrieves orders specified by customer id
func (r ApiOrderFindRequest) CustomerId(customerId string) ApiOrderFindRequest {
	r.customerId = &customerId
	return r
}

// Retrieves orders specified by customer email
func (r ApiOrderFindRequest) CustomerEmail(customerEmail string) ApiOrderFindRequest {
	r.customerEmail = &customerEmail
	return r
}

// Retrieves orders specified by order status
func (r ApiOrderFindRequest) OrderStatus(orderStatus string) ApiOrderFindRequest {
	r.orderStatus = &orderStatus
	return r
}
...
// Retrieve entities to their creation date
func (r ApiOrderFindRequest) CreatedTo(createdTo string) ApiOrderFindRequest {
	r.createdTo = &createdTo
	return r
}

// Retrieve entities from their creation date
func (r ApiOrderFindRequest) CreatedFrom(createdFrom string) ApiOrderFindRequest {
	r.createdFrom = &createdFrom
	return r
}

// Retrieve entities to their modification date
func (r ApiOrderFindRequest) ModifiedTo(modifiedTo string) ApiOrderFindRequest {
	r.modifiedTo = &modifiedTo
	return r
}

// Retrieve entities from their modification date
func (r ApiOrderFindRequest) ModifiedFrom(modifiedFrom string) ApiOrderFindRequest {
	r.modifiedFrom = &modifiedFrom
	return r
}
...
func (r ApiOrderFindRequest) Execute() (*OrderFind200Response, *http.Response, error) {
	return r.ApiService.OrderFindExecute(r)
}
...
This method is deprecated and won't be supported in the future. Please use "order.list" instead.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiOrderFindRequest

Deprecated
*/
func (a *OrderAPIService) OrderFind(ctx context.Context) ApiOrderFindRequest {
	return ApiOrderFindRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Deprecated
func (a *OrderAPIService) OrderFindExecute(r ApiOrderFindRequest) (*OrderFind200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *OrderFind200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrderAPIService.OrderFind")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/order.find.json"
