...
// checks if the ModelResponseWebhookCount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseWebhookCount{}

// ModelResponseWebhookCount struct for ModelResponseWebhookCount
type ModelResponseWebhookCount struct {
	ReturnCode NullableInt32 `json:"return_code,omitempty"`
	ReturnMessage NullableString `json:"return_message,omitempty"`
	Result NullableResponseWebhookCountResult `json:"result,omitempty"`
...
func NewModelResponseWebhookCount() *ModelResponseWebhookCount {
	this := ModelResponseWebhookCount{}
	return &this
}
...
func (o *ModelResponseWebhookCount) SetReturnCodeNil() {
...
func (o *ModelResponseWebhookCount) SetReturnMessageNil() {
...
func (o *ModelResponseWebhookCount) GetResult() ResponseWebhookCountResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseWebhookCountResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseWebhookCountResult and assigns it to the Result field.
func (o *ModelResponseWebhookCount) SetResult(v ResponseWebhookCountResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseWebhookCount) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseWebhookCount) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseWebhookCount) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseWebhookCount struct {
	value *ModelResponseWebhookCount
	isSet bool
}

func (v NullableModelResponseWebhookCount) Get() *ModelResponseWebhookCount {
	return v.value
}

func (v *NullableModelResponseWebhookCount) Set(val *ModelResponseWebhookCount) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseWebhookCount) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseWebhookCount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseWebhookCount(val *ModelResponseWebhookCount) *NullableModelResponseWebhookCount {
	return &NullableModelResponseWebhookCount{value: val, isSet: true}
}

func (v NullableModelResponseWebhookCount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseWebhookCount) UnmarshalJSON(src []byte) error {
	v.isSet = true
