...
// checks if the ModelResponseCustomerGroupList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseCustomerGroupList{}

// ModelResponseCustomerGroupList struct for ModelResponseCustomerGroupList
type ModelResponseCustomerGroupList struct {
	...
	Result NullableResponseCustomerGroupListResult `json:"result,omitempty"`
...
func NewModelResponseCustomerGroupList() *ModelResponseCustomerGroupList {
	this := ModelResponseCustomerGroupList{}
	return &this
}
...
func (o *ModelResponseCustomerGroupList) SetReturnCodeNil() {
...
func (o *ModelResponseCustomerGroupList) SetReturnMessageNil() {
...
func (o *ModelResponseCustomerGroupList) SetPaginationNil() {
...
func (o *ModelResponseCustomerGroupList) GetResult() ResponseCustomerGroupListResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseCustomerGroupListResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseCustomerGroupListResult and assigns it to the Result field.
func (o *ModelResponseCustomerGroupList) SetResult(v ResponseCustomerGroupListResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseCustomerGroupList) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseCustomerGroupList) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseCustomerGroupList) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseCustomerGroupList struct {
	value *ModelResponseCustomerGroupList
	isSet bool
}

func (v NullableModelResponseCustomerGroupList) Get() *ModelResponseCustomerGroupList {
	return v.value
}

func (v *NullableModelResponseCustomerGroupList) Set(val *ModelResponseCustomerGroupList) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseCustomerGroupList) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseCustomerGroupList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseCustomerGroupList(val *ModelResponseCustomerGroupList) *NullableModelResponseCustomerGroupList {
	return &NullableModelResponseCustomerGroupList{value: val, isSet: true}
}

func (v NullableModelResponseCustomerGroupList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseCustomerGroupList) UnmarshalJSON(src []byte) error {
	v.isSet = true
