...
type ModelResponseReturnList struct {
	...
	Result *ResponseReturnListResult `json:"result,omitempty"`
...
// SetResult gets a reference to the given ResponseReturnListResult and assigns it to the Result field.
