...
// checks if the ProductAdd200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductAdd200Response{}

// ProductAdd200Response struct for ProductAdd200Response
type ProductAdd200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *ProductAdd200ResponseResult `json:"result,omitempty"`
}
...
func (o *ProductAdd200Response) GetResult() ProductAdd200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret ProductAdd200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given ProductAdd200ResponseResult and assigns it to the Result field.
func (o *ProductAdd200Response) SetResult(v ProductAdd200ResponseResult) {
	o.Result = &v
}

func (o ProductAdd200Response) MarshalJSON() ([]byte, error) {
...
func (o ProductAdd200Response) ToMap() (map[string]interface{}, error) {
...
type NullableProductAdd200Response struct {
	value *ProductAdd200Response
	isSet bool
}

func (v NullableProductAdd200Response) Get() *ProductAdd200Response {
	return v.value
}

func (v *NullableProductAdd200Response) Set(val *ProductAdd200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableProductAdd200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableProductAdd200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductAdd200Response(val *ProductAdd200Response) *NullableProductAdd200Response {
	return &NullableProductAdd200Response{value: val, isSet: true}
}

func (v NullableProductAdd200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductAdd200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
