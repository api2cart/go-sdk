...
// checks if the ModelResponseCustomerWishlistList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseCustomerWishlistList{}

// ModelResponseCustomerWishlistList struct for ModelResponseCustomerWishlistList
type ModelResponseCustomerWishlistList struct {
	...
	Result NullableResponseCustomerWishlistListResult `json:"result,omitempty"`
...
func NewModelResponseCustomerWishlistList() *ModelResponseCustomerWishlistList {
	this := ModelResponseCustomerWishlistList{}
	return &this
}
...
func (o *ModelResponseCustomerWishlistList) SetReturnCodeNil() {
...
func (o *ModelResponseCustomerWishlistList) SetReturnMessageNil() {
...
func (o *ModelResponseCustomerWishlistList) SetPaginationNil() {
...
func (o *ModelResponseCustomerWishlistList) GetResult() ResponseCustomerWishlistListResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseCustomerWishlistListResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseCustomerWishlistListResult and assigns it to the Result field.
func (o *ModelResponseCustomerWishlistList) SetResult(v ResponseCustomerWishlistListResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseCustomerWishlistList) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseCustomerWishlistList) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseCustomerWishlistList) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseCustomerWishlistList struct {
	value *ModelResponseCustomerWishlistList
	isSet bool
}

func (v NullableModelResponseCustomerWishlistList) Get() *ModelResponseCustomerWishlistList {
	return v.value
}

func (v *NullableModelResponseCustomerWishlistList) Set(val *ModelResponseCustomerWishlistList) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseCustomerWishlistList) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseCustomerWishlistList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseCustomerWishlistList(val *ModelResponseCustomerWishlistList) *NullableModelResponseCustomerWishlistList {
	return &NullableModelResponseCustomerWishlistList{value: val, isSet: true}
}

func (v NullableModelResponseCustomerWishlistList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseCustomerWishlistList) UnmarshalJSON(src []byte) error {
	v.isSet = true
