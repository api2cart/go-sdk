...
type ModelResponseCustomerWishlistList struct {
	...
	Result *ResponseCustomerWishlistListResult `json:"result,omitempty"`
...
// SetResult gets a reference to the given ResponseCustomerWishlistListResult and assigns it to the Result field.
