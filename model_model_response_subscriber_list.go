...
type ModelResponseSubscriberList struct {
	...
	Result NullableResponseSubscriberListResult `json:"result,omitempty"`
...
func (o *ModelResponseSubscriberList) SetReturnCodeNil() {
...
func (o *ModelResponseSubscriberList) SetReturnMessageNil() {
...
func (o *ModelResponseSubscriberList) SetPaginationNil() {
...
// SetResult gets a reference to the given NullableResponseSubscriberListResult and assigns it to the Result field.
func (o *ModelResponseSubscriberList) SetResult(v ResponseSubscriberListResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseSubscriberList) SetResultNil() {
	o.Result.Set(nil)
}
