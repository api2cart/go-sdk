...
// checks if the OrderCount200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderCount200Response{}

// OrderCount200Response struct for OrderCount200Response
type OrderCount200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *OrderCount200ResponseResult `json:"result,omitempty"`
}
...
func (o *OrderCount200Response) GetResult() OrderCount200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret OrderCount200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given OrderCount200ResponseResult and assigns it to the Result field.
func (o *OrderCount200Response) SetResult(v OrderCount200ResponseResult) {
	o.Result = &v
}

func (o OrderCount200Response) MarshalJSON() ([]byte, error) {
...
func (o OrderCount200Response) ToMap() (map[string]interface{}, error) {
...
type NullableOrderCount200Response struct {
	value *OrderCount200Response
	isSet bool
}

func (v NullableOrderCount200Response) Get() *OrderCount200Response {
	return v.value
}

func (v *NullableOrderCount200Response) Set(val *OrderCount200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderCount200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderCount200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderCount200Response(val *OrderCount200Response) *NullableOrderCount200Response {
	return &NullableOrderCount200Response{value: val, isSet: true}
}

func (v NullableOrderCount200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderCount200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
