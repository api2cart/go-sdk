...
// checks if the AttributeAdd200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AttributeAdd200Response{}

// AttributeAdd200Response struct for AttributeAdd200Response
type AttributeAdd200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *AttributeAdd200ResponseResult `json:"result,omitempty"`
}
...
func (o *AttributeAdd200Response) GetResult() AttributeAdd200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret AttributeAdd200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given AttributeAdd200ResponseResult and assigns it to the Result field.
func (o *AttributeAdd200Response) SetResult(v AttributeAdd200ResponseResult) {
	o.Result = &v
}

func (o AttributeAdd200Response) MarshalJSON() ([]byte, error) {
...
func (o AttributeAdd200Response) ToMap() (map[string]interface{}, error) {
...
type NullableAttributeAdd200Response struct {
	value *AttributeAdd200Response
	isSet bool
}

func (v NullableAttributeAdd200Response) Get() *AttributeAdd200Response {
	return v.value
}

func (v *NullableAttributeAdd200Response) Set(val *AttributeAdd200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAttributeAdd200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAttributeAdd200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAttributeAdd200Response(val *AttributeAdd200Response) *NullableAttributeAdd200Response {
	return &NullableAttributeAdd200Response{value: val, isSet: true}
}

func (v NullableAttributeAdd200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAttributeAdd200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
