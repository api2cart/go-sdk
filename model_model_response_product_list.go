...
// checks if the ModelResponseProductList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseProductList{}

// ModelResponseProductList struct for ModelResponseProductList
type ModelResponseProductList struct {
	...
	Result NullableResponseProductListResult `json:"result,omitempty"`
...
func (o *ModelResponseProductList) SetReturnCodeNil() {
...
func (o *ModelResponseProductList) SetReturnMessageNil() {
...
func (o *ModelResponseProductList) SetPaginationNil() {
...
func (o *ModelResponseProductList) GetResult() ResponseProductListResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseProductListResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseProductListResult and assigns it to the Result field.
func (o *ModelResponseProductList) SetResult(v ResponseProductListResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseProductList) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseProductList) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseProductList) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseProductList struct {
	value *ModelResponseProductList
	isSet bool
}

func (v NullableModelResponseProductList) Get() *ModelResponseProductList {
	return v.value
}

func (v *NullableModelResponseProductList) Set(val *ModelResponseProductList) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseProductList) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseProductList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseProductList(val *ModelResponseProductList) *NullableModelResponseProductList {
	return &NullableModelResponseProductList{value: val, isSet: true}
}

func (v NullableModelResponseProductList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseProductList) UnmarshalJSON(src []byte) error {
	v.isSet = true
