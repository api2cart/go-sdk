...
// checks if the ModelResponseOrderShipmentEventList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseOrderShipmentEventList{}

// ModelResponseOrderShipmentEventList struct for ModelResponseOrderShipmentEventList
type ModelResponseOrderShipmentEventList struct {
	...
	Result NullableResponseOrderShipmentEventListResult `json:"result,omitempty"`
...
func NewModelResponseOrderShipmentEventList() *ModelResponseOrderShipmentEventList {
	this := ModelResponseOrderShipmentEventList{}
	return &this
}
...
func (o *ModelResponseOrderShipmentEventList) SetReturnCodeNil() {
...
func (o *ModelResponseOrderShipmentEventList) SetReturnMessageNil() {
...
func (o *ModelResponseOrderShipmentEventList) SetPaginationNil() {
...
func (o *ModelResponseOrderShipmentEventList) GetResult() ResponseOrderShipmentEventListResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseOrderShipmentEventListResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseOrderShipmentEventListResult and assigns it to the Result field.
func (o *ModelResponseOrderShipmentEventList) SetResult(v ResponseOrderShipmentEventListResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseOrderShipmentEventList) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseOrderShipmentEventList) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseOrderShipmentEventList) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseOrderShipmentEventList struct {
	value *ModelResponseOrderShipmentEventList
	isSet bool
}

func (v NullableModelResponseOrderShipmentEventList) Get() *ModelResponseOrderShipmentEventList {
	return v.value
}

func (v *NullableModelResponseOrderShipmentEventList) Set(val *ModelResponseOrderShipmentEventList) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseOrderShipmentEventList) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseOrderShipmentEventList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseOrderShipmentEventList(val *ModelResponseOrderShipmentEventList) *NullableModelResponseOrderShipmentEventList {
	return &NullableModelResponseOrderShipmentEventList{value: val, isSet: true}
}

func (v NullableModelResponseOrderShipmentEventList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseOrderShipmentEventList) UnmarshalJSON(src []byte) error {
	v.isSet = true
