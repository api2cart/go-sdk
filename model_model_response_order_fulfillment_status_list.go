...
// checks if the ModelResponseOrderFulfillmentStatusList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseOrderFulfillmentStatusList{}

// ModelResponseOrderFulfillmentStatusList struct for ModelResponseOrderFulfillmentStatusList
type ModelResponseOrderFulfillmentStatusList struct {
	ReturnCode NullableInt32 `json:"return_code,omitempty"`
	ReturnMessage NullableString `json:"return_message,omitempty"`
	Result NullableResponseOrderFulfillmentStatusListResult `json:"result,omitempty"`
...
func NewModelResponseOrderFulfillmentStatusList() *ModelResponseOrderFulfillmentStatusList {
	this := ModelResponseOrderFulfillmentStatusList{}
	return &this
}
...
func (o *ModelResponseOrderFulfillmentStatusList) SetReturnCodeNil() {
...
func (o *ModelResponseOrderFulfillmentStatusList) SetReturnMessageNil() {
...
func (o *ModelResponseOrderFulfillmentStatusList) GetResult() ResponseOrderFulfillmentStatusListResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseOrderFulfillmentStatusListResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseOrderFulfillmentStatusListResult and assigns it to the Result field.
func (o *ModelResponseOrderFulfillmentStatusList) SetResult(v ResponseOrderFulfillmentStatusListResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseOrderFulfillmentStatusList) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseOrderFulfillmentStatusList) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseOrderFulfillmentStatusList) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseOrderFulfillmentStatusList struct {
	value *ModelResponseOrderFulfillmentStatusList
	isSet bool
}

func (v NullableModelResponseOrderFulfillmentStatusList) Get() *ModelResponseOrderFulfillmentStatusList {
	return v.value
}

func (v *NullableModelResponseOrderFulfillmentStatusList) Set(val *ModelResponseOrderFulfillmentStatusList) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseOrderFulfillmentStatusList) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseOrderFulfillmentStatusList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseOrderFulfillmentStatusList(val *ModelResponseOrderFulfillmentStatusList) *NullableModelResponseOrderFulfillmentStatusList {
	return &NullableModelResponseOrderFulfillmentStatusList{value: val, isSet: true}
}

func (v NullableModelResponseOrderFulfillmentStatusList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseOrderFulfillmentStatusList) UnmarshalJSON(src []byte) error {
	v.isSet = true
