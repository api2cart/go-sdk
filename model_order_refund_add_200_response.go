...
// checks if the OrderRefundAdd200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderRefundAdd200Response{}

// OrderRefundAdd200Response struct for OrderRefundAdd200Response
type OrderRefundAdd200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *OrderRefundAdd200ResponseResult `json:"result,omitempty"`
}
...
func NewOrderRefundAdd200Response() *OrderRefundAdd200Response {
	this := OrderRefundAdd200Response{}
	return &this
}
...
func (o *OrderRefundAdd200Response) GetResult() OrderRefundAdd200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret OrderRefundAdd200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given OrderRefundAdd200ResponseResult and assigns it to the Result field.
func (o *OrderRefundAdd200Response) SetResult(v OrderRefundAdd200ResponseResult) {
	o.Result = &v
}

func (o OrderRefundAdd200Response) MarshalJSON() ([]byte, error) {
...
func (o OrderRefundAdd200Response) ToMap() (map[string]interface{}, error) {
...
type NullableOrderRefundAdd200Response struct {
	value *OrderRefundAdd200Response
	isSet bool
}

func (v NullableOrderRefundAdd200Response) Get() *OrderRefundAdd200Response {
	return v.value
}

func (v *NullableOrderRefundAdd200Response) Set(val *OrderRefundAdd200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderRefundAdd200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderRefundAdd200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderRefundAdd200Response(val *OrderRefundAdd200Response) *NullableOrderRefundAdd200Response {
	return &NullableOrderRefundAdd200Response{value: val, isSet: true}
}

func (v NullableOrderRefundAdd200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderRefundAdd200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
