...
// checks if the CartClearCache200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CartClearCache200Response{}

// CartClearCache200Response struct for CartClearCache200Response
type CartClearCache200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *CartClearCache200ResponseResult `json:"result,omitempty"`
}
...
func NewCartClearCache200Response() *CartClearCache200Response {
	this := CartClearCache200Response{}
	return &this
}
...
func (o *CartClearCache200Response) GetResult() CartClearCache200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret CartClearCache200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given CartClearCache200ResponseResult and assigns it to the Result field.
func (o *CartClearCache200Response) SetResult(v CartClearCache200ResponseResult) {
	o.Result = &v
}

func (o CartClearCache200Response) MarshalJSON() ([]byte, error) {
...
func (o CartClearCache200Response) ToMap() (map[string]interface{}, error) {
...
type NullableCartClearCache200Response struct {
	value *CartClearCache200Response
	isSet bool
}

func (v NullableCartClearCache200Response) Get() *CartClearCache200Response {
	return v.value
}

func (v *NullableCartClearCache200Response) Set(val *CartClearCache200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCartClearCache200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCartClearCache200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCartClearCache200Response(val *CartClearCache200Response) *NullableCartClearCache200Response {
	return &NullableCartClearCache200Response{value: val, isSet: true}
}

func (v NullableCartClearCache200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCartClearCache200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
