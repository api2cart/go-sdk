...
// checks if the ModelResponseWebhookEvents type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseWebhookEvents{}

// ModelResponseWebhookEvents struct for ModelResponseWebhookEvents
type ModelResponseWebhookEvents struct {
	ReturnCode NullableInt32 `json:"return_code,omitempty"`
	ReturnMessage NullableString `json:"return_message,omitempty"`
	Result NullableResponseWebhookEventsResult `json:"result,omitempty"`
...
func NewModelResponseWebhookEvents() *ModelResponseWebhookEvents {
	this := ModelResponseWebhookEvents{}
	return &this
}
...
func (o *ModelResponseWebhookEvents) SetReturnCodeNil() {
...
func (o *ModelResponseWebhookEvents) SetReturnMessageNil() {
...
func (o *ModelResponseWebhookEvents) GetResult() ResponseWebhookEventsResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseWebhookEventsResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseWebhookEventsResult and assigns it to the Result field.
func (o *ModelResponseWebhookEvents) SetResult(v ResponseWebhookEventsResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseWebhookEvents) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseWebhookEvents) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseWebhookEvents) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseWebhookEvents struct {
	value *ModelResponseWebhookEvents
	isSet bool
}

func (v NullableModelResponseWebhookEvents) Get() *ModelResponseWebhookEvents {
	return v.value
}

func (v *NullableModelResponseWebhookEvents) Set(val *ModelResponseWebhookEvents) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseWebhookEvents) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseWebhookEvents) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseWebhookEvents(val *ModelResponseWebhookEvents) *NullableModelResponseWebhookEvents {
	return &NullableModelResponseWebhookEvents{value: val, isSet: true}
}

func (v NullableModelResponseWebhookEvents) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseWebhookEvents) UnmarshalJSON(src []byte) error {
	v.isSet = true
