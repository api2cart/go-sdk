...
// checks if the ProductFind200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductFind200Response{}

// ProductFind200Response struct for ProductFind200Response
type ProductFind200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *ProductFind200ResponseResult `json:"result,omitempty"`
}
...
func (o *ProductFind200Response) GetResult() ProductFind200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret ProductFind200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given ProductFind200ResponseResult and assigns it to the Result field.
func (o *ProductFind200Response) SetResult(v ProductFind200ResponseResult) {
	o.Result = &v
}

func (o ProductFind200Response) MarshalJSON() ([]byte, error) {
...
func (o ProductFind200Response) ToMap() (map[string]interface{}, error) {
...
type NullableProductFind200Response struct {
	value *ProductFind200Response
	isSet bool
}

func (v NullableProductFind200Response) Get() *ProductFind200Response {
	return v.value
}

func (v *NullableProductFind200Response) Set(val *ProductFind200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableProductFind200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableProductFind200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductFind200Response(val *ProductFind200Response) *NullableProductFind200Response {
	return &NullableProductFind200Response{value: val, isSet: true}
}

func (v NullableProductFind200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductFind200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
