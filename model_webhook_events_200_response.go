...
// checks if the WebhookEvents200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookEvents200Response{}

// WebhookEvents200Response struct for WebhookEvents200Response
type WebhookEvents200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *WebhookEvents200ResponseResult `json:"result,omitempty"`
}
...
func (o *WebhookEvents200Response) GetResult() WebhookEvents200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret WebhookEvents200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given WebhookEvents200ResponseResult and assigns it to the Result field.
func (o *WebhookEvents200Response) SetResult(v WebhookEvents200ResponseResult) {
	o.Result = &v
}

func (o WebhookEvents200Response) MarshalJSON() ([]byte, error) {
...
func (o WebhookEvents200Response) ToMap() (map[string]interface{}, error) {
...
type NullableWebhookEvents200Response struct {
	value *WebhookEvents200Response
	isSet bool
}

func (v NullableWebhookEvents200Response) Get() *WebhookEvents200Response {
	return v.value
}

func (v *NullableWebhookEvents200Response) Set(val *WebhookEvents200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookEvents200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookEvents200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookEvents200Response(val *WebhookEvents200Response) *NullableWebhookEvents200Response {
	return &NullableWebhookEvents200Response{value: val, isSet: true}
}

func (v NullableWebhookEvents200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookEvents200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
