...
// checks if the AttributeUnassignGroup200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AttributeUnassignGroup200Response{}

// AttributeUnassignGroup200Response struct for AttributeUnassignGroup200Response
type AttributeUnassignGroup200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *AttributeUnassignGroup200ResponseResult `json:"result,omitempty"`
}
...
func NewAttributeUnassignGroup200Response() *AttributeUnassignGroup200Response {
	this := AttributeUnassignGroup200Response{}
	return &this
}
...
func (o *AttributeUnassignGroup200Response) GetResult() AttributeUnassignGroup200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret AttributeUnassignGroup200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given AttributeUnassignGroup200ResponseResult and assigns it to the Result field.
func (o *AttributeUnassignGroup200Response) SetResult(v AttributeUnassignGroup200ResponseResult) {
	o.Result = &v
}

func (o AttributeUnassignGroup200Response) MarshalJSON() ([]byte, error) {
...
func (o AttributeUnassignGroup200Response) ToMap() (map[string]interface{}, error) {
...
type NullableAttributeUnassignGroup200Response struct {
	value *AttributeUnassignGroup200Response
	isSet bool
}

func (v NullableAttributeUnassignGroup200Response) Get() *AttributeUnassignGroup200Response {
	return v.value
}

func (v *NullableAttributeUnassignGroup200Response) Set(val *AttributeUnassignGroup200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAttributeUnassignGroup200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAttributeUnassignGroup200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAttributeUnassignGroup200Response(val *AttributeUnassignGroup200Response) *NullableAttributeUnassignGroup200Response {
	return &NullableAttributeUnassignGroup200Response{value: val, isSet: true}
}

func (v NullableAttributeUnassignGroup200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAttributeUnassignGroup200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
