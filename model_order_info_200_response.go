...
// checks if the OrderInfo200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderInfo200Response{}

// OrderInfo200Response struct for OrderInfo200Response
type OrderInfo200Response struct {
...
// SetResult gets a reference to the given Order and assigns it to the Result field.
func (o *OrderInfo200Response) SetResult(v Order) {
	o.Result = &v
}

func (o OrderInfo200Response) MarshalJSON() ([]byte, error) {
...
func (o OrderInfo200Response) ToMap() (map[string]interface{}, error) {
...
type NullableOrderInfo200Response struct {
	value *OrderInfo200Response
	isSet bool
}

func (v NullableOrderInfo200Response) Get() *OrderInfo200Response {
	return v.value
}

func (v *NullableOrderInfo200Response) Set(val *OrderInfo200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderInfo200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderInfo200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderInfo200Response(val *OrderInfo200Response) *NullableOrderInfo200Response {
	return &NullableOrderInfo200Response{value: val, isSet: true}
}

func (v NullableOrderInfo200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderInfo200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
