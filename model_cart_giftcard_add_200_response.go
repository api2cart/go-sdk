...
// checks if the CartGiftcardAdd200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CartGiftcardAdd200Response{}

// CartGiftcardAdd200Response struct for CartGiftcardAdd200Response
type CartGiftcardAdd200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *CartGiftcardAdd200ResponseResult `json:"result,omitempty"`
}
...
func NewCartGiftcardAdd200Response() *CartGiftcardAdd200Response {
	this := CartGiftcardAdd200Response{}
	return &this
}
...
func (o *CartGiftcardAdd200Response) GetResult() CartGiftcardAdd200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret CartGiftcardAdd200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given CartGiftcardAdd200ResponseResult and assigns it to the Result field.
func (o *CartGiftcardAdd200Response) SetResult(v CartGiftcardAdd200ResponseResult) {
	o.Result = &v
}

func (o CartGiftcardAdd200Response) MarshalJSON() ([]byte, error) {
...
func (o CartGiftcardAdd200Response) ToMap() (map[string]interface{}, error) {
...
type NullableCartGiftcardAdd200Response struct {
	value *CartGiftcardAdd200Response
	isSet bool
}

func (v NullableCartGiftcardAdd200Response) Get() *CartGiftcardAdd200Response {
	return v.value
}

func (v *NullableCartGiftcardAdd200Response) Set(val *CartGiftcardAdd200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCartGiftcardAdd200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCartGiftcardAdd200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCartGiftcardAdd200Response(val *CartGiftcardAdd200Response) *NullableCartGiftcardAdd200Response {
	return &NullableCartGiftcardAdd200Response{value: val, isSet: true}
}

func (v NullableCartGiftcardAdd200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCartGiftcardAdd200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
