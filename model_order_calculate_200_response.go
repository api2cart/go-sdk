...
// checks if the OrderCalculate200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderCalculate200Response{}

// OrderCalculate200Response struct for OrderCalculate200Response
type OrderCalculate200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *OrderCalculate `json:"result,omitempty"`
}
...
func NewOrderCalculate200Response() *OrderCalculate200Response {
	this := OrderCalculate200Response{}
	return &this
}
...
// SetResult gets a reference to the given OrderCalculate and assigns it to the Result field.
func (o *OrderCalculate200Response) SetResult(v OrderCalculate) {
	o.Result = &v
}

func (o OrderCalculate200Response) MarshalJSON() ([]byte, error) {
...
func (o OrderCalculate200Response) ToMap() (map[string]interface{}, error) {
...
type NullableOrderCalculate200Response struct {
	value *OrderCalculate200Response
	isSet bool
}

func (v NullableOrderCalculate200Response) Get() *OrderCalculate200Response {
	return v.value
}

func (v *NullableOrderCalculate200Response) Set(val *OrderCalculate200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderCalculate200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderCalculate200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderCalculate200Response(val *OrderCalculate200Response) *NullableOrderCalculate200Response {
	return &NullableOrderCalculate200Response{value: val, isSet: true}
}

func (v NullableOrderCalculate200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderCalculate200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
