...
// checks if the OrderFind200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderFind200Response{}

// OrderFind200Response struct for OrderFind200Response
type OrderFind200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *OrderFind200ResponseResult `json:"result,omitempty"`
}
...
func (o *OrderFind200Response) GetResult() OrderFind200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret OrderFind200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given OrderFind200ResponseResult and assigns it to the Result field.
func (o *OrderFind200Response) SetResult(v OrderFind200ResponseResult) {
	o.Result = &v
}

func (o OrderFind200Response) MarshalJSON() ([]byte, error) {
...
func (o OrderFind200Response) ToMap() (map[string]interface{}, error) {
...
type NullableOrderFind200Response struct {
	value *OrderFind200Response
	isSet bool
}

func (v NullableOrderFind200Response) Get() *OrderFind200Response {
	return v.value
}

func (v *NullableOrderFind200Response) Set(val *OrderFind200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderFind200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderFind200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderFind200Response(val *OrderFind200Response) *NullableOrderFind200Response {
	return &NullableOrderFind200Response{value: val, isSet: true}
}

func (v NullableOrderFind200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderFind200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
