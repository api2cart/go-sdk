...
// checks if the AccountSupportedPlatforms200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountSupportedPlatforms200Response{}

// AccountSupportedPlatforms200Response struct for AccountSupportedPlatforms200Response
type AccountSupportedPlatforms200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *AccountSupportedPlatforms200ResponseResult `json:"result,omitempty"`
}
...
func NewAccountSupportedPlatforms200Response() *AccountSupportedPlatforms200Response {
	this := AccountSupportedPlatforms200Response{}
	return &this
}
...
func (o *AccountSupportedPlatforms200Response) GetResult() AccountSupportedPlatforms200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret AccountSupportedPlatforms200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given AccountSupportedPlatforms200ResponseResult and assigns it to the Result field.
func (o *AccountSupportedPlatforms200Response) SetResult(v AccountSupportedPlatforms200ResponseResult) {
	o.Result = &v
}

func (o AccountSupportedPlatforms200Response) MarshalJSON() ([]byte, error) {
...
func (o AccountSupportedPlatforms200Response) ToMap() (map[string]interface{}, error) {
...
type NullableAccountSupportedPlatforms200Response struct {
	value *AccountSupportedPlatforms200Response
	isSet bool
}

func (v NullableAccountSupportedPlatforms200Response) Get() *AccountSupportedPlatforms200Response {
	return v.value
}

func (v *NullableAccountSupportedPlatforms200Response) Set(val *AccountSupportedPlatforms200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountSupportedPlatforms200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountSupportedPlatforms200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountSupportedPlatforms200Response(val *AccountSupportedPlatforms200Response) *NullableAccountSupportedPlatforms200Response {
	return &NullableAccountSupportedPlatforms200Response{value: val, isSet: true}
}

func (v NullableAccountSupportedPlatforms200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountSupportedPlatforms200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
