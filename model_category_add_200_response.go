...
// checks if the CategoryAdd200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryAdd200Response{}

// CategoryAdd200Response struct for CategoryAdd200Response
type CategoryAdd200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *CategoryAdd200ResponseResult `json:"result,omitempty"`
}
...
func (o *CategoryAdd200Response) GetResult() CategoryAdd200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret CategoryAdd200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given CategoryAdd200ResponseResult and assigns it to the Result field.
func (o *CategoryAdd200Response) SetResult(v CategoryAdd200ResponseResult) {
	o.Result = &v
}

func (o CategoryAdd200Response) MarshalJSON() ([]byte, error) {
...
func (o CategoryAdd200Response) ToMap() (map[string]interface{}, error) {
...
type NullableCategoryAdd200Response struct {
	value *CategoryAdd200Response
	isSet bool
}

func (v NullableCategoryAdd200Response) Get() *CategoryAdd200Response {
	return v.value
}

func (v *NullableCategoryAdd200Response) Set(val *CategoryAdd200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryAdd200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryAdd200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryAdd200Response(val *CategoryAdd200Response) *NullableCategoryAdd200Response {
	return &NullableCategoryAdd200Response{value: val, isSet: true}
}

func (v NullableCategoryAdd200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryAdd200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
