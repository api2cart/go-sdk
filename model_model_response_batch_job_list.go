...
type ModelResponseBatchJobList struct {
	...
	Result *ResponseBatchJobListResult `json:"result,omitempty"`
...
// SetResult gets a reference to the given ResponseBatchJobListResult and assigns it to the Result field.
