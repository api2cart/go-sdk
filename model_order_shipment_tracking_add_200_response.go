...
// checks if the OrderShipmentTrackingAdd200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderShipmentTrackingAdd200Response{}

// OrderShipmentTrackingAdd200Response struct for OrderShipmentTrackingAdd200Response
type OrderShipmentTrackingAdd200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *OrderShipmentTrackingAdd200ResponseResult `json:"result,omitempty"`
}
...
func NewOrderShipmentTrackingAdd200Response() *OrderShipmentTrackingAdd200Response {
	this := OrderShipmentTrackingAdd200Response{}
	return &this
}
...
func (o *OrderShipmentTrackingAdd200Response) GetResult() OrderShipmentTrackingAdd200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret OrderShipmentTrackingAdd200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given OrderShipmentTrackingAdd200ResponseResult and assigns it to the Result field.
func (o *OrderShipmentTrackingAdd200Response) SetResult(v OrderShipmentTrackingAdd200ResponseResult) {
	o.Result = &v
}

func (o OrderShipmentTrackingAdd200Response) MarshalJSON() ([]byte, error) {
...
func (o OrderShipmentTrackingAdd200Response) ToMap() (map[string]interface{}, error) {
...
type NullableOrderShipmentTrackingAdd200Response struct {
	value *OrderShipmentTrackingAdd200Response
	isSet bool
}

func (v NullableOrderShipmentTrackingAdd200Response) Get() *OrderShipmentTrackingAdd200Response {
	return v.value
}

func (v *NullableOrderShipmentTrackingAdd200Response) Set(val *OrderShipmentTrackingAdd200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderShipmentTrackingAdd200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderShipmentTrackingAdd200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderShipmentTrackingAdd200Response(val *OrderShipmentTrackingAdd200Response) *NullableOrderShipmentTrackingAdd200Response {
	return &NullableOrderShipmentTrackingAdd200Response{value: val, isSet: true}
}

func (v NullableOrderShipmentTrackingAdd200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderShipmentTrackingAdd200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
