...
// checks if the ModelResponseMarketplaceProductFind type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseMarketplaceProductFind{}

// ModelResponseMarketplaceProductFind struct for ModelResponseMarketplaceProductFind
type ModelResponseMarketplaceProductFind struct {
	...
	Result NullableResponseMarketplaceProductFindResult `json:"result,omitempty"`
...
func NewModelResponseMarketplaceProductFind() *ModelResponseMarketplaceProductFind {
	this := ModelResponseMarketplaceProductFind{}
	return &this
}
...
func (o *ModelResponseMarketplaceProductFind) SetReturnCodeNil() {
...
func (o *ModelResponseMarketplaceProductFind) SetReturnMessageNil() {
...
func (o *ModelResponseMarketplaceProductFind) SetPaginationNil() {
...
func (o *ModelResponseMarketplaceProductFind) GetResult() ResponseMarketplaceProductFindResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseMarketplaceProductFindResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseMarketplaceProductFindResult and assigns it to the Result field.
func (o *ModelResponseMarketplaceProductFind) SetResult(v ResponseMarketplaceProductFindResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseMarketplaceProductFind) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseMarketplaceProductFind) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseMarketplaceProductFind) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseMarketplaceProductFind struct {
	value *ModelResponseMarketplaceProductFind
	isSet bool
}

func (v NullableModelResponseMarketplaceProductFind) Get() *ModelResponseMarketplaceProductFind {
	return v.value
}

func (v *NullableModelResponseMarketplaceProductFind) Set(val *ModelResponseMarketplaceProductFind) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseMarketplaceProductFind) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseMarketplaceProductFind) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseMarketplaceProductFind(val *ModelResponseMarketplaceProductFind) *NullableModelResponseMarketplaceProductFind {
	return &NullableModelResponseMarketplaceProductFind{value: val, isSet: true}
}

func (v NullableModelResponseMarketplaceProductFind) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseMarketplaceProductFind) UnmarshalJSON(src []byte) error {
	v.isSet = true
