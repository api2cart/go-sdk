...
type ModelResponseMarketplaceProductFind struct {
	...
	Result *ResponseMarketplaceProductFindResult `json:"result,omitempty"`
...
// SetResult gets a reference to the given ResponseMarketplaceProductFindResult and assigns it to the Result field.
