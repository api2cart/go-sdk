...
// checks if the AccountConfigUpdate200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountConfigUpdate200Response{}

// AccountConfigUpdate200Response struct for AccountConfigUpdate200Response
type AccountConfigUpdate200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *AccountConfigUpdate200ResponseResult `json:"result,omitempty"`
}
...
func NewAccountConfigUpdate200Response() *AccountConfigUpdate200Response {
	this := AccountConfigUpdate200Response{}
	return &this
}
...
func (o *AccountConfigUpdate200Response) GetResult() AccountConfigUpdate200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret AccountConfigUpdate200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given AccountConfigUpdate200ResponseResult and assigns it to the Result field.
func (o *AccountConfigUpdate200Response) SetResult(v AccountConfigUpdate200ResponseResult) {
	o.Result = &v
}

func (o AccountConfigUpdate200Response) MarshalJSON() ([]byte, error) {
...
func (o AccountConfigUpdate200Response) ToMap() (map[string]interface{}, error) {
...
type NullableAccountConfigUpdate200Response struct {
	value *AccountConfigUpdate200Response
	isSet bool
}

func (v NullableAccountConfigUpdate200Response) Get() *AccountConfigUpdate200Response {
	return v.value
}

func (v *NullableAccountConfigUpdate200Response) Set(val *AccountConfigUpdate200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountConfigUpdate200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountConfigUpdate200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountConfigUpdate200Response(val *AccountConfigUpdate200Response) *NullableAccountConfigUpdate200Response {
	return &NullableAccountConfigUpdate200Response{value: val, isSet: true}
}

func (v NullableAccountConfigUpdate200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountConfigUpdate200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
