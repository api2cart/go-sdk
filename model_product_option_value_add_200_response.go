...
// checks if the ProductOptionValueAdd200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductOptionValueAdd200Response{}

// ProductOptionValueAdd200Response struct for ProductOptionValueAdd200Response
type ProductOptionValueAdd200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *ProductOptionValueAdd200ResponseResult `json:"result,omitempty"`
}
...
func NewProductOptionValueAdd200Response() *ProductOptionValueAdd200Response {
	this := ProductOptionValueAdd200Response{}
	return &this
}
...
func (o *ProductOptionValueAdd200Response) GetResult() ProductOptionValueAdd200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret ProductOptionValueAdd200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given ProductOptionValueAdd200ResponseResult and assigns it to the Result field.
func (o *ProductOptionValueAdd200Response) SetResult(v ProductOptionValueAdd200ResponseResult) {
	o.Result = &v
}

func (o ProductOptionValueAdd200Response) MarshalJSON() ([]byte, error) {
...
func (o ProductOptionValueAdd200Response) ToMap() (map[string]interface{}, error) {
...
type NullableProductOptionValueAdd200Response struct {
	value *ProductOptionValueAdd200Response
	isSet bool
}

func (v NullableProductOptionValueAdd200Response) Get() *ProductOptionValueAdd200Response {
	return v.value
}

func (v *NullableProductOptionValueAdd200Response) Set(val *ProductOptionValueAdd200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableProductOptionValueAdd200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableProductOptionValueAdd200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductOptionValueAdd200Response(val *ProductOptionValueAdd200Response) *NullableProductOptionValueAdd200Response {
	return &NullableProductOptionValueAdd200Response{value: val, isSet: true}
}

func (v NullableProductOptionValueAdd200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductOptionValueAdd200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
