...
// checks if the ReturnReasonList200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReturnReasonList200Response{}

// ReturnReasonList200Response struct for ReturnReasonList200Response
type ReturnReasonList200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *ReturnReasonList200ResponseResult `json:"result,omitempty"`
}
...
func NewReturnReasonList200Response() *ReturnReasonList200Response {
	this := ReturnReasonList200Response{}
	return &this
}
...
func (o *ReturnReasonList200Response) GetResult() ReturnReasonList200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret ReturnReasonList200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given ReturnReasonList200ResponseResult and assigns it to the Result field.
func (o *ReturnReasonList200Response) SetResult(v ReturnReasonList200ResponseResult) {
	o.Result = &v
}

func (o ReturnReasonList200Response) MarshalJSON() ([]byte, error) {
...
func (o ReturnReasonList200Response) ToMap() (map[string]interface{}, error) {
...
type NullableReturnReasonList200Response struct {
	value *ReturnReasonList200Response
	isSet bool
}

func (v NullableReturnReasonList200Response) Get() *ReturnReasonList200Response {
	return v.value
}

func (v *NullableReturnReasonList200Response) Set(val *ReturnReasonList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableReturnReasonList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableReturnReasonList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReturnReasonList200Response(val *ReturnReasonList200Response) *NullableReturnReasonList200Response {
	return &NullableReturnReasonList200Response{value: val, isSet: true}
}

func (v NullableReturnReasonList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReturnReasonList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
