...
// checks if the ProductOptionValueAssign200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductOptionValueAssign200Response{}

// ProductOptionValueAssign200Response struct for ProductOptionValueAssign200Response
type ProductOptionValueAssign200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *ProductOptionValueAssign200ResponseResult `json:"result,omitempty"`
}
...
func NewProductOptionValueAssign200Response() *ProductOptionValueAssign200Response {
	this := ProductOptionValueAssign200Response{}
	return &this
}
...
func (o *ProductOptionValueAssign200Response) GetResult() ProductOptionValueAssign200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret ProductOptionValueAssign200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given ProductOptionValueAssign200ResponseResult and assigns it to the Result field.
func (o *ProductOptionValueAssign200Response) SetResult(v ProductOptionValueAssign200ResponseResult) {
	o.Result = &v
}

func (o ProductOptionValueAssign200Response) MarshalJSON() ([]byte, error) {
...
func (o ProductOptionValueAssign200Response) ToMap() (map[string]interface{}, error) {
...
type NullableProductOptionValueAssign200Response struct {
	value *ProductOptionValueAssign200Response
	isSet bool
}

func (v NullableProductOptionValueAssign200Response) Get() *ProductOptionValueAssign200Response {
	return v.value
}

func (v *NullableProductOptionValueAssign200Response) Set(val *ProductOptionValueAssign200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableProductOptionValueAssign200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableProductOptionValueAssign200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductOptionValueAssign200Response(val *ProductOptionValueAssign200Response) *NullableProductOptionValueAssign200Response {
	return &NullableProductOptionValueAssign200Response{value: val, isSet: true}
}

func (v NullableProductOptionValueAssign200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductOptionValueAssign200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
