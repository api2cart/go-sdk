...
// checks if the AccountCartAdd200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountCartAdd200Response{}

// AccountCartAdd200Response struct for AccountCartAdd200Response
type AccountCartAdd200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *AccountCartAdd200ResponseResult `json:"result,omitempty"`
}
...
func NewAccountCartAdd200Response() *AccountCartAdd200Response {
	this := AccountCartAdd200Response{}
	return &this
}
...
func (o *AccountCartAdd200Response) GetResult() AccountCartAdd200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret AccountCartAdd200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given AccountCartAdd200ResponseResult and assigns it to the Result field.
func (o *AccountCartAdd200Response) SetResult(v AccountCartAdd200ResponseResult) {
	o.Result = &v
}

func (o AccountCartAdd200Response) MarshalJSON() ([]byte, error) {
...
func (o AccountCartAdd200Response) ToMap() (map[string]interface{}, error) {
...
type NullableAccountCartAdd200Response struct {
	value *AccountCartAdd200Response
	isSet bool
}

func (v NullableAccountCartAdd200Response) Get() *AccountCartAdd200Response {
	return v.value
}

func (v *NullableAccountCartAdd200Response) Set(val *AccountCartAdd200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountCartAdd200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountCartAdd200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountCartAdd200Response(val *AccountCartAdd200Response) *NullableAccountCartAdd200Response {
	return &NullableAccountCartAdd200Response{value: val, isSet: true}
}

func (v NullableAccountCartAdd200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountCartAdd200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
