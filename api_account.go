...
func (r ApiAccountConfigUpdateRequest) NopcommerceSecret(nopcommerceSecret string) ApiAccountConfigUpdateRequest {
	r.nopcommerceSecret = &nopcommerceSecret
	return r
}
...
func (a *AccountAPIService) AccountConfigUpdateExecute(r ApiAccountConfigUpdateRequest) (*AccountConfigUpdate200Response, *http.Response, error) {
	...
	if r.nopcommerceSecret != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "nopcommerce_secret", r.nopcommerceSecret, "form", "")
	}
