...
// checks if the AttributeDelete200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AttributeDelete200Response{}

// AttributeDelete200Response struct for AttributeDelete200Response
type AttributeDelete200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *AttributeDelete200ResponseResult `json:"result,omitempty"`
}
...
func NewAttributeDelete200Response() *AttributeDelete200Response {
	this := AttributeDelete200Response{}
	return &this
}
...
func (o *AttributeDelete200Response) GetResult() AttributeDelete200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret AttributeDelete200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given AttributeDelete200ResponseResult and assigns it to the Result field.
func (o *AttributeDelete200Response) SetResult(v AttributeDelete200ResponseResult) {
	o.Result = &v
}

func (o AttributeDelete200Response) MarshalJSON() ([]byte, error) {
...
func (o AttributeDelete200Response) ToMap() (map[string]interface{}, error) {
...
type NullableAttributeDelete200Response struct {
	value *AttributeDelete200Response
	isSet bool
}

func (v NullableAttributeDelete200Response) Get() *AttributeDelete200Response {
	return v.value
}

func (v *NullableAttributeDelete200Response) Set(val *AttributeDelete200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAttributeDelete200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAttributeDelete200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAttributeDelete200Response(val *AttributeDelete200Response) *NullableAttributeDelete200Response {
	return &NullableAttributeDelete200Response{value: val, isSet: true}
}

func (v NullableAttributeDelete200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAttributeDelete200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
