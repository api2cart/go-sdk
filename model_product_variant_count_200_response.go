...
// checks if the ProductVariantCount200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductVariantCount200Response{}

// ProductVariantCount200Response struct for ProductVariantCount200Response
type ProductVariantCount200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *ProductVariantCount200ResponseResult `json:"result,omitempty"`
}
...
func NewProductVariantCount200Response() *ProductVariantCount200Response {
	this := ProductVariantCount200Response{}
	return &this
}
...
func (o *ProductVariantCount200Response) GetResult() ProductVariantCount200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret ProductVariantCount200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given ProductVariantCount200ResponseResult and assigns it to the Result field.
func (o *ProductVariantCount200Response) SetResult(v ProductVariantCount200ResponseResult) {
	o.Result = &v
}

func (o ProductVariantCount200Response) MarshalJSON() ([]byte, error) {
...
func (o ProductVariantCount200Response) ToMap() (map[string]interface{}, error) {
...
type NullableProductVariantCount200Response struct {
	value *ProductVariantCount200Response
	isSet bool
}

func (v NullableProductVariantCount200Response) Get() *ProductVariantCount200Response {
	return v.value
}

func (v *NullableProductVariantCount200Response) Set(val *ProductVariantCount200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableProductVariantCount200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableProductVariantCount200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductVariantCount200Response(val *ProductVariantCount200Response) *NullableProductVariantCount200Response {
	return &NullableProductVariantCount200Response{value: val, isSet: true}
}

func (v NullableProductVariantCount200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductVariantCount200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
