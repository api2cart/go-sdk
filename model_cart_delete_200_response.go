...
// checks if the CartDelete200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CartDelete200Response{}

// CartDelete200Response struct for CartDelete200Response
type CartDelete200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *CartDelete200ResponseResult `json:"result,omitempty"`
}
...
func (o *CartDelete200Response) GetResult() CartDelete200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret CartDelete200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given CartDelete200ResponseResult and assigns it to the Result field.
func (o *CartDelete200Response) SetResult(v CartDelete200ResponseResult) {
	o.Result = &v
}

func (o CartDelete200Response) MarshalJSON() ([]byte, error) {
...
func (o CartDelete200Response) ToMap() (map[string]interface{}, error) {
...
type NullableCartDelete200Response struct {
	value *CartDelete200Response
	isSet bool
}

func (v NullableCartDelete200Response) Get() *CartDelete200Response {
	return v.value
}

func (v *NullableCartDelete200Response) Set(val *CartDelete200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCartDelete200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCartDelete200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCartDelete200Response(val *CartDelete200Response) *NullableCartDelete200Response {
	return &NullableCartDelete200Response{value: val, isSet: true}
}

func (v NullableCartDelete200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCartDelete200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
