...
// checks if the ReturnStatusList200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReturnStatusList200Response{}

// ReturnStatusList200Response struct for ReturnStatusList200Response
type ReturnStatusList200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *ReturnStatusList200ResponseResult `json:"result,omitempty"`
}
...
func NewReturnStatusList200Response() *ReturnStatusList200Response {
	this := ReturnStatusList200Response{}
	return &this
}
...
func (o *ReturnStatusList200Response) GetResult() ReturnStatusList200ResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret ReturnStatusList200ResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given ReturnStatusList200ResponseResult and assigns it to the Result field.
func (o *ReturnStatusList200Response) SetResult(v ReturnStatusList200ResponseResult) {
	o.Result = &v
}

func (o ReturnStatusList200Response) MarshalJSON() ([]byte, error) {
...
func (o ReturnStatusList200Response) ToMap() (map[string]interface{}, error) {
...
type NullableReturnStatusList200Response struct {
	value *ReturnStatusList200Response
	isSet bool
}

func (v NullableReturnStatusList200Response) Get() *ReturnStatusList200Response {
	return v.value
}

func (v *NullableReturnStatusList200Response) Set(val *ReturnStatusList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableReturnStatusList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableReturnStatusList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReturnStatusList200Response(val *ReturnStatusList200Response) *NullableReturnStatusList200Response {
	return &NullableReturnStatusList200Response{value: val, isSet: true}
}

func (v NullableReturnStatusList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReturnStatusList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
