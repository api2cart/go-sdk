...
// checks if the ModelResponseOrderPreestimateShippingList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseOrderPreestimateShippingList{}

// ModelResponseOrderPreestimateShippingList struct for ModelResponseOrderPreestimateShippingList
type ModelResponseOrderPreestimateShippingList struct {
	...
	Result NullableResponseOrderPreestimateShippingListResult `json:"result,omitempty"`
...
func NewModelResponseOrderPreestimateShippingList() *ModelResponseOrderPreestimateShippingList {
	this := ModelResponseOrderPreestimateShippingList{}
	return &this
}
...
func (o *ModelResponseOrderPreestimateShippingList) SetReturnCodeNil() {
...
func (o *ModelResponseOrderPreestimateShippingList) SetReturnMessageNil() {
...
func (o *ModelResponseOrderPreestimateShippingList) SetPaginationNil() {
...
func (o *ModelResponseOrderPreestimateShippingList) GetResult() ResponseOrderPreestimateShippingListResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseOrderPreestimateShippingListResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseOrderPreestimateShippingListResult and assigns it to the Result field.
func (o *ModelResponseOrderPreestimateShippingList) SetResult(v ResponseOrderPreestimateShippingListResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseOrderPreestimateShippingList) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseOrderPreestimateShippingList) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseOrderPreestimateShippingList) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseOrderPreestimateShippingList struct {
	value *ModelResponseOrderPreestimateShippingList
	isSet bool
}

func (v NullableModelResponseOrderPreestimateShippingList) Get() *ModelResponseOrderPreestimateShippingList {
	return v.value
}

func (v *NullableModelResponseOrderPreestimateShippingList) Set(val *ModelResponseOrderPreestimateShippingList) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseOrderPreestimateShippingList) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseOrderPreestimateShippingList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseOrderPreestimateShippingList(val *ModelResponseOrderPreestimateShippingList) *NullableModelResponseOrderPreestimateShippingList {
	return &NullableModelResponseOrderPreestimateShippingList{value: val, isSet: true}
}

func (v NullableModelResponseOrderPreestimateShippingList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseOrderPreestimateShippingList) UnmarshalJSON(src []byte) error {
	v.isSet = true
