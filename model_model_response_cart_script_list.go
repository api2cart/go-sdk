...
// checks if the ModelResponseCartScriptList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelResponseCartScriptList{}

// ModelResponseCartScriptList struct for ModelResponseCartScriptList
type ModelResponseCartScriptList struct {
	...
	Result NullableResponseCartScriptListResult `json:"result,omitempty"`
...
func NewModelResponseCartScriptList() *ModelResponseCartScriptList {
	this := ModelResponseCartScriptList{}
	return &this
}
...
func (o *ModelResponseCartScriptList) SetReturnCodeNil() {
...
func (o *ModelResponseCartScriptList) SetReturnMessageNil() {
...
func (o *ModelResponseCartScriptList) SetPaginationNil() {
...
func (o *ModelResponseCartScriptList) GetResult() ResponseCartScriptListResult {
	if o == nil || IsNil(o.Result.Get()) {
		var ret ResponseCartScriptListResult
		return ret
	}
	return *o.Result.Get()
}
...
// SetResult gets a reference to the given NullableResponseCartScriptListResult and assigns it to the Result field.
func (o *ModelResponseCartScriptList) SetResult(v ResponseCartScriptListResult) {
	o.Result.Set(&v)
}
// SetResultNil sets the value for Result to be an explicit nil
func (o *ModelResponseCartScriptList) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ModelResponseCartScriptList) MarshalJSON() ([]byte, error) {
...
func (o ModelResponseCartScriptList) ToMap() (map[string]interface{}, error) {
...
type NullableModelResponseCartScriptList struct {
	value *ModelResponseCartScriptList
	isSet bool
}

func (v NullableModelResponseCartScriptList) Get() *ModelResponseCartScriptList {
	return v.value
}

func (v *NullableModelResponseCartScriptList) Set(val *ModelResponseCartScriptList) {
	v.value = val
	v.isSet = true
}

func (v NullableModelResponseCartScriptList) IsSet() bool {
	return v.isSet
}

func (v *NullableModelResponseCartScriptList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelResponseCartScriptList(val *ModelResponseCartScriptList) *NullableModelResponseCartScriptList {
	return &NullableModelResponseCartScriptList{value: val, isSet: true}
}

func (v NullableModelResponseCartScriptList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelResponseCartScriptList) UnmarshalJSON(src []byte) error {
	v.isSet = true
