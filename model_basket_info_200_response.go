...
// checks if the BasketInfo200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BasketInfo200Response{}

// BasketInfo200Response struct for BasketInfo200Response
type BasketInfo200Response struct {
	ReturnCode *int32 `json:"return_code,omitempty"`
	ReturnMessage *string `json:"return_message,omitempty"`
	Result *Basket `json:"result,omitempty"`
}
...
// SetResult gets a reference to the given Basket and assigns it to the Result field.
func (o *BasketInfo200Response) SetResult(v Basket) {
	o.Result = &v
}

func (o BasketInfo200Response) MarshalJSON() ([]byte, error) {
...
func (o BasketInfo200Response) ToMap() (map[string]interface{}, error) {
...
type NullableBasketInfo200Response struct {
	value *BasketInfo200Response
	isSet bool
}

func (v NullableBasketInfo200Response) Get() *BasketInfo200Response {
	return v.value
}

func (v *NullableBasketInfo200Response) Set(val *BasketInfo200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBasketInfo200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBasketInfo200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBasketInfo200Response(val *BasketInfo200Response) *NullableBasketInfo200Response {
	return &NullableBasketInfo200Response{value: val, isSet: true}
}

func (v NullableBasketInfo200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBasketInfo200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
